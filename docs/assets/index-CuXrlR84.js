...
`)},undoImportBatch(e){const t=this.getFinanceSettings().baseCurrency,n=this.getActiveFinanceEvents().filter(r=>String(r.metadata?.importBatchId||"")===String(e)).map(r=>({type:"finance.event_reversed",amount:0,currency:r.currency||t,timestamp:Ee(String(r.related_entity_id||r.id)),related_entity_id:r.id,metadata:{reason:"undoImportBatch",reversed_event_id:r.id,importBatchId:e}}));return n.length?this.appendFinanceEvents(n,{source:"undoImportBatch"}):[]},getPriceCache(){return fn(ae.priceCache,nr)},async refreshCryptoPrices(){const e=this.getUiSettings(),t=Ls(e.walletPriceSource),n=(this.getFinancialReadModel().web3Positions||[]).filter(y=>y.manualPriceOverride!==!0);if(!n.length||t.id==="manual")return{updated:0,source:t.id};const r=n.map(y=>String(y.symbolOrName||"")).filter(Boolean);let o;try{o=await t.getQuotes(r,this.getFinanceSettings().baseCurrency)}catch(y){return{updated:0,source:t.id,error:y instanceof Error?y.message:"Price refresh failed."}}const c=new Map(o.map(y=>[y.symbol.toUpperCase(),y])),u=this.getFinanceSettings().baseCurrency,m=n.flatMap(y=>{const h=c.get(String(y.symbolOrName||"").toUpperCase());return h?[{type:"asset.position_set",amount:0,currency:u,timestamp:new Date().toISOString(),related_entity_id:String(y.id),metadata:{symbolOrName:y.symbolOrName,chain:y.chain,amount:y.amount,price:h.price,liquidity:y.liquidity,scope:De(y.scope),priceSource:h.source,priceUpdatedAt:h.quotedAt,manualPriceOverride:!1}}]:[]}),f=this.getPriceCache();return o.forEach(y=>{f.quotes[y.symbol.toUpperCase()]=y}),Oe(ae.priceCache,f),m.length&&this.appendFinanceEvents(m,{source:"refreshCryptoPrices"}),{updated:m.length,source:t.id}},exportBackup(){const e=new Date().toISOString(),t={version:wa,exportedAt:e,ledger:this.getFinanceLedger(),financeSettings:this.getFinanceSettings(),uiSettings:this.getUiSettings(),review:this.getReviewState(),goals:this.getGoals(),imports:this.getImportState(),scenarios:this.getSavedScenarios(),prices:this.getPriceCache()};return{...t,metadata:yr(t,Un,ya)}},recordBackupExport(e=new Date().toISOString()){Oe(ae.backupMeta,{lastBackupAt:e})},previewBackup(e){return Ta(e,{latestLocalEventAt:this.getLocalDataHealth().latestEventAt})},restoreBackup(e){const t=Ks(e);return Oe(ae.ledger,t.ledger),Oe(ae.settings,t.financeSettings||bi),Oe(ae.ui,t.uiSettings||ma),Oe(ae.review,t.review||Xa),Oe(ae.goals,t.goals||er),Oe(ae.imports,t.imports||tr),Oe(ae.scenarios,t.scenarios||ir),Oe(ae.priceCache,t.prices||nr),ai(ae.demoSeed,"restored-backup"),ri(),window.dispatchEvent(new CustomEvent("finance:ui-updated",{detail:qe(this.getUiSettings())})),Jt(this.getFinancialSnapshot(!0),"restoreBackup"),this.exportBackup()},getLocalDataHealth(){const e=fn(ae.backupMeta,fc);return{...Es({ledger:rt(ae.ledger),settings:rt(ae.settings),ui:rt(ae.ui),review:rt(ae.review),goals:rt(ae.goals),imports:rt(ae.imports),scenarios:rt(ae.scenarios),priceCache:rt(ae.priceCache)}),...ar,schemaLabel:Un,backupVersion:wa,lastBackupAt:typeof e.lastBackupAt=="string"?e.lastBackupAt:null,migrationStatus:rr,storageKeys:[...Ga]}},resetLocalFinanceData(){return Ga.forEach(e=>Ri(e)),ai(ae.demoSeed,"deleted"),ri(),window.dispatchEvent(new CustomEvent("finance:ui-updated",{detail:qe(this.getUiSettings())})),Jt(this.getFinancialSnapshot(!0),"resetLocalFinanceData"),this.getLocalDataHealth()},deleteInvoice(e,t={}){const n=this.getFinanceSettings().baseCurrency,r=Ee(e,t.timestamp),o=[];return t.reverseSettlement===!0&&this.getActiveFinanceEvents().filter(c=>{const u=c.metadata||{};return String(c.related_entity_id||"")===e||String(u.invoiceId||"")===e}).filter(c=>["invoice.paid","income.received","asset.account_set"].includes(c.type)).forEach(c=>o.push({type:"finance.event_reversed",amount:0,currency:c.currency||n,timestamp:r,related_entity_id:c.id,metadata:{reason:"deleteInvoice",reversed_event_id:c.id,entity_id:e}})),o.push({type:"pipeline.stage_changed",amount:0,currency:n,timestamp:r,related_entity_id:e,metadata:{stage:"cancelled",status:"cancelled"}}),this.appendFinanceEvents(o,{source:"deleteInvoice"})},seedDemoIfNeeded(e=!1){const t=In(),n=String(qi(ae.demoSeed,"")||"");if(!e&&t.length>0){n||ai(ae.demoSeed,"existing-ledger");return}if(!e&&["deleted","restored-backup","existing-ledger","empty-setup"].includes(n))return;const r=this.getFinanceSettings().baseCurrency,o=new Date().toISOString(),c=bs(r);if(!window.FinanceLedger?.appendEvents)throw new Error("Finance ledger module is unavailable.");const u=window.FinanceLedger.appendEvents([],c,{...this.getFinanceSettings(),nowIso:o},{nowIso:o,allowApproximateTimestamp:!1});fa(u.events),ai(ae.demoSeed,"1"),Jt(this.getFinancialSnapshot(!0),"seedDemoIfNeeded")},clearAndReseedDemo(){Ri(ae.ledger),Ri(ae.demoSeed),ri(),this.seedDemoIfNeeded(!0),Jt(this.getFinancialSnapshot(!0),"clearAndReseedDemo")},deleteSampleData(){Ri(ae.ledger),ai(ae.demoSeed,"deleted"),ri(),Jt(this.getFinancialSnapshot(!0),"deleteSampleData")}};function _a(e){const t=e.getUiSettings();document.documentElement.dataset.appearance=t.appearance,document.documentElement.classList.toggle("settings-reduced-motion",t.reducedMotion),document.body.classList.toggle("settings-reduced-motion",t.reducedMotion)}const $c=[",",";","	"];function Ic(e){return String(e||"").toLowerCase().replace(/[^a-z0-9]/g,"")}function On(e,t){return e.find(n=>t.includes(Ic(n)))||""}function Aa(e,t){const n=[];let r="",o=!1;for(let c=0;c<e.length;c+=1){const u=e[c];u==='"'&&e[c+1]==='"'?(r+='"',c+=1):u==='"'?o=!o:u===t&&!o?(n.push(r.trim()),r=""):r+=u}return n.push(r.trim()),n}function Ac(e){const t=$c.map(n=>({delimiter:n,fields:Aa(e,n).length})).sort((n,r)=>r.fields-n.fields);return t[0].fields>1?t[0].delimiter:","}function Ma(e){const t=String(e||"").split(/\r?\n/).filter(o=>o.trim());if(t.length<2)throw new Error("Provide a header row and at least one transaction.");const n=Ac(t[0]),r=Aa(t[0],n).map(o=>o.trim());if(r.some(o=>!o))throw new Error("Every CSV column needs a header.");if(new Set(r).size!==r.length)throw new Error("CSV headers must be unique.");return{delimiter:n,headers:r,rows:t.slice(1).map((o,c)=>({rowNumber:c+2,values:Aa(o,n)}))}}function Fr(e){return{date:On(e,["date","bookingdate","transactiondate","valuedate"]),description:On(e,["description","memo","note","details","payee","reference","narrative"]),amount:On(e,["amount","value","total","transactionamount"]),debit:On(e,["debit","withdrawal","outflow","moneyout"]),credit:On(e,["credit","deposit","inflow","moneyin"]),category:On(e,["category","categoryid"]),scope:On(e,["scope","group"])}}function Mc(e){const t=String(e||"").trim(),n=t.match(/^(\d{1,2})[./](\d{1,2})[./](\d{4})$/),r=n?`${n[3]}-${n[2].padStart(2,"0")}-${n[1].padStart(2,"0")}`:t,o=Date.parse(`${r}T12:00:00`);return Number.isFinite(o)?new Date(o).toISOString().slice(0,10):""}function ga(e){const t=String(e||"").trim();if(!t)return 0;const n=t.startsWith("(")&&t.endsWith(")");let r=t.replace(/[()\s']/g,"").replace(/[^\d,.-]/g,"");const o=r.lastIndexOf(","),c=r.lastIndexOf(".");if(o>=0&&c>=0){const m=o>c?",":".";r=r.replace(m===","?/\./g:/,/g,"").replace(m,".")}else if(o>=0){const m=r.length-o-1;r=m>0&&m<=2?r.replace(",","."):r.replace(/,/g,"")}const u=Number(r);return Number.isFinite(u)?n?-Math.abs(u):u:Number.NaN}function _n(e,t,n){if(!n)return"";const r=e.headers.indexOf(n);return r>=0?String(t.values[r]||"").trim():""}function Nc(e){return`${e.date}|${e.description.trim().toLowerCase()}|${Number(e.amount).toFixed(2)}`}function Dc(e,t,n={}){const r=[],o=[],c=[],u=new Set(n.existingFingerprints||[]),m=new Set,f=String(n.defaultCategory||"uncategorized").trim()||"uncategorized",y=["personal","shared"].includes(n.defaultScope)?n.defaultScope:"business",h=new Set(e.headers),b=[t.date,t.description].filter(Boolean);if(b.length!==2||b.some(N=>!h.has(N)))throw new Error("Map both the date and description columns.");const _=!!(t.amount&&h.has(t.amount)),B=!!(t.debit&&h.has(t.debit)||t.credit&&h.has(t.credit));if(!_&&!B)throw new Error("Map a signed amount column or at least one debit or credit column.");return e.rows.forEach(N=>{const x=Mc(_n(e,N,t.date)),q=_n(e,N,t.description),H=_?ga(_n(e,N,t.amount)):Math.abs(ga(_n(e,N,t.credit)))-Math.abs(ga(_n(e,N,t.debit)));if(!x){r.push({rowNumber:N.rowNumber,reason:"Date is missing or invalid."});return}if(!q){r.push({rowNumber:N.rowNumber,reason:"Description is missing."});return}if(!Number.isFinite(H)||H===0){r.push({rowNumber:N.rowNumber,reason:"Amount must be non-zero."});return}const fe=_n(e,N,t.scope).toLowerCase(),J=["personal","business","shared"].includes(fe)?fe:y,K={date:x,description:q,amount:Math.round(H*100)/100,categoryId:_n(e,N,t.category)||f,scope:J};if(K.fingerprint=Nc(K),u.has(K.fingerprint)||m.has(K.fingerprint)){o.push(K);return}m.add(K.fingerprint),c.push(K)}),{rows:c,rejected:r,duplicates:o,sourceFile:String(n.sourceFile||"pasted-transactions.csv")}}function Cc(e){return e==="	"?"Tab":e===";"?"Semicolon":"Comma"}function L(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function nn(e="shared"){return[["business","Business"],["personal","Personal"],["shared","Shared"]].map(([t,n])=>`<option value="${t}"${e===t?" selected":""}>${n}</option>`).join("")}function xc(e="all"){return`<option value="all"${e==="all"?" selected":""}>All scopes</option>${nn(e)}`}function hn(e){const t=Date.parse(String(e||""));return Number.isFinite(t)?new Date(t).toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"}):"Unknown date"}function kc(e){const t=String(e||"").replace(/_/g," ").replace(/\./g," ");return t?t.charAt(0).toUpperCase()+t.slice(1):"Transaction"}function Fc(e){const t=Number(e.signedAmount);if(Number.isFinite(t))return t;const n=Math.abs(Number(e.amount)||0);return String(e.type)==="expense.recorded"?-n:n}function Xe(e,t=!1){return`
  ...
  `}function Ki(e,t){return t?`<button class="btn-danger ui-btn" type="button" data-action="${e}">Deactivate</button>`:""}function Tc(){return`
  ...
  `}function Ec(e="expense",t){const n=["expense","income","transfer","adjustment"].includes(e)?e:"expense";return`
    <div class="modal-form">
      ...
      <div class="modal-grid-dynamic" data-active-type="${n}">
        ...
        <div class="form-group fg-scope conditional-income-expense">
          ...
          <select id="modal-fast-txn-scope">${nn("business")}</select>
        </div>
  ...
  `}const Tt=document.querySelector("#modal-overlay"),Dn=document.querySelector("#modal-body");let qn="",gn="",Vn="",Ii="pasted-transactions.csv",Qe=null,Ft={date:"",description:""},Ke=null,Hn="uncategorized",Wn="business",Ai="skip",kn="",Ln=null,ci=null,Na=null;const Tr=["lead","proposal","expected","confirmed","invoiced","due","overdue","paid","cancelled","lost"],Pc={paid:1,invoiced:.95,due:.95,overdue:.85,confirmed:.9,retainer:.9,expected:.6,proposal:.4,lead:.15,cancelled:0,lost:0};let li=null;const Cn=document.getElementById("quick-action-menu"),Da=document.querySelector(".fin-fab-add"),Ie={search:"",accountId:"",scope:"all",categoryId:"",type:"all",reviewStatus:"all",dateFrom:"",dateTo:""};function T(e){return document.querySelector(`#${e}`)?.value.trim()||""}function Si(e){return document.querySelector(`#${e}`)?.checked===!0}function an(){return window.FinanceDates?.todayDateOnly?.()||new Date().toISOString().slice(0,10)}function cr(e=an()){return window.FinanceDates?.dateOnlyToNoonIso?.(e)||new Date().toISOString()}function yi(e){return`${e}-${window.FinanceEvents?.createId?.()||Date.now().toString(36)}`}function Pe(e){const t=te.getFinanceSettings();return new Intl.NumberFormat(void 0,{style:"currency",currency:t.baseCurrency,maximumFractionDigits:2}).format(Number(e)||0)}function Rc(){const e=li;return e?`
    <div class="modal-form">
  ...
  `:'<div class="modal-form"><h2 id="modal-title">Confirmation unavailable</h2><p class="modal-copy">Close this dialog and try the action again.</p></div>'}function Oc(){const e=document.querySelector("#modal-destructive-phrase"),t=document.querySelector("#modal-destructive-confirm");!e||!t||!li||(t.disabled=e.value!==li.phrase)}function Er(e){!Cn||!Da||(Cn.classList.toggle("active",e),Cn.setAttribute("aria-hidden",e?"false":"true"),Da.setAttribute("aria-expanded",e?"true":"false"))}function _c(){Er(!(Cn?.classList.contains("active")??!1))}function Mi(){Er(!1)}function jn(e="",t="Not mapped"){const n=Qe?.headers||[];return`<option value="">${t}</option>${n.map(r=>`<option value="${L(r)}"${r===e?" selected":""}>${L(r)}</option>`).join("")}`}function Hi(e){return String(e||"").replace(/\\/g,"\\\\").replace(/'/g,"\\'")}function lr(e){return e.map(t=>String(t||"").trim().toLowerCase()).filter(Boolean).join("|")}function jc(){if(!Qe)return[];const e=lr(Qe.headers);return e?(te.getImportState().profiles||[]).filter(n=>lr(n.headers||[])===e):[]}function Bc(e){e&&(Ft={...e.mapping},Hn=e.defaultCategory||Hn,Wn=e.defaultScope||Wn,e.accountId&&(Vn=e.accountId),kn=e.name||"CSV mapping")}function Pr(){const e=te.getImportState(),t=jc(),n=t.find(r=>r.id===e.lastProfileId)||t[0];Bc(n)}function dr(){if(Qe)try{kn=te.saveCsvImportProfile({name:Ii,sourceFile:Ii,headers:Qe.headers,mapping:Ft,accountId:Vn,defaultCategory:Hn,defaultScope:Wn}).name}catch{}}function ye(e){if(!Dn)return;let t=Dn.querySelector(".modal-error");t||(t=document.createElement("div"),t.className="modal-error",t.setAttribute("role","alert"),t.tabIndex=-1,Dn.querySelector("h2")?.insertAdjacentElement("afterend",t)),t.textContent=e,t.focus()}function Lc(){const e=te.getFinancialSnapshot(),t=te.getFinancialReadModel(),n=window.FinanceDates?.toDateOnly?.(Ie.dateFrom)||"",r=window.FinanceDates?.toDateOnly?.(Ie.dateTo)||"",o=Ie.search.toLowerCase(),c=(t.transactions||[]).filter(u=>!Ie.accountId||String(u.accountId)===Ie.accountId||String(u.fromAccountId)===Ie.accountId||String(u.toAccountId)===Ie.accountId).filter(u=>Ie.scope==="all"||String(u.scope)===Ie.scope).filter(u=>!Ie.categoryId||String(u.categoryId).toLowerCase().includes(Ie.categoryId.toLowerCase())).filter(u=>Ie.type==="all"||String(u.ledgerType||u.type)===Ie.type||String(u.type)===Ie.type).filter(u=>Ie.reviewStatus==="all"||String(u.reviewStatus||"clear")===Ie.reviewStatus).filter(u=>o?[u.description,u.accountName,u.fromAccountName,u.toAccountName,u.categoryId].some(m=>String(m||"").toLowerCase().includes(o)):!0).filter(u=>{const m=window.FinanceDates?.toDateOnly?.(u.timestamp)||"";return(!n||m>=n)&&(!r||m<=r)});return`
    <div class="modal-form">
      ...
      <div class="modal-section">
        ...
        <div class="modal-grid-three">
          ...
          <select id="modal-filter-account" aria-label="Filter by account">${vn(Ie.accountId)}</select>
          <select id="modal-filter-scope" aria-label="Filter by scope">${xc(Ie.scope)}</select>
      ...
      <div class="modal-section">
        ...
        ${c.length?c.map(u=>{const m=Fc(u),f=m>=0,y=u.ledgerType==="transfer"?`${L(u.fromAccountName||"From account")} → ${L(u.toAccountName||"To account")}`:L(u.accountName||"Unassigned");return`
          <div class="modal-list-row">
            <span><strong>${L(u.description||u.type)}</strong><br><small>${y} · ${L(u.categoryId||"uncategorized")} · ${L(u.reviewStatus||"clear")} · ${hn(u.timestamp)}</small></span>
            <span>${kc(u.ledgerType||u.type)}${u.obligationId?` · ${L(u.obligationTitle||u.obligationId)}`:""}</span>
            <span class="${f?"fin-val-pos":"fin-val-neg"}">${f?"+":"-"}${Pe(Math.abs(m))}</span>
            <button class="fin-mini-btn" type="button" data-action="openEditModal" data-action-args="'transactionReview', '${L(Hi(u.id))}'">Review</button>
          </div>
      ...
      <div class="modal-section">
        ...
        <div class="modal-grid-three">
          ...
          <input id="modal-txn-date" aria-label="Transaction date" type="date" value="${an()}" />
          <select id="modal-txn-account" aria-label="Transaction account">${vn("",!1)}</select>
          <select id="modal-txn-to-account" aria-label="Transfer destination account">${vn("",!1)}</select>
          ...
          <select id="modal-txn-scope" aria-label="Transaction scope">${nn("business")}</select>
        </div>
        <button class="btn-primary ui-btn ui-btn--primary" type="button" data-action="addTransaction">Add transaction</button>
      </div>
    </div>
  `}function Uc(e="expense"){return Ec(e,{accountOptions:vn,projectOptions:di,today:an})}function zc(e=""){const t=(te.getFinancialReadModel().pipelineDeals||[]).find(n=>String(n.id)===e);return`
    <div class="modal-form">
      ...
      <div class="form-group"><label for="modal-settle-account">Settlement account</label><select id="modal-settle-account">${vn(String(t?.destinationAccountId||""),!1)}</select></div>
      ${Xe("settleIncome")}
    </div>
  `}function qc(){const e=te.getFinancialReadModel(),t=te.getFinancialSnapshot(),n=te.getReviewState(),r=e.fiatAccounts||[],o=[["unresolvedItems","1. Resolve unclear items",t.attentionQueue?t.attentionQueue.filter(c=>c.type==="Needs review").length===0:!0,"Categorize or clarify any ambiguous transactions."],["matchPayments","2. Match payments",!0,"Link incoming cash to expected invoices."],["confirmObligations","3. Confirm obligations",t.attentionQueue?t.attentionQueue.filter(c=>c.type==="Due soon"||c.type==="Overdue").length===0:!0,"Mark due costs as paid or deferred."],["reviewSignals","4. Review signals",Number(t.runwayMonths)>=3,"Inspect runway, low points, and missing inputs."],["closeMonth","5. Save checkpoint",!0,"Save the current review and reset the operating cycle."]];return`
    <div class="modal-form">
      ...
      <p class="modal-copy">Last reviewed: ${n.lastReviewedAt?hn(n.lastReviewedAt):"Not reviewed yet"}</p>
      <div class="modal-actions">
  ...
  `}function Vc(){const e=te.getGoalProgress();return`
    <div class="modal-form">
  ...
  `}function Hc(e=""){const t=te.getGoals().goals.find(r=>r.id===e),n=te.getFinancialReadModel().fiatAccounts||[];return`
    <div class="modal-form">
      ...
      <div class="modal-grid-two">
        ...
        <div class="form-group"><label for="modal-goal-scope">Scope</label><select id="modal-goal-scope">${nn(t?.scope||"shared")}</select></div>
      </div>
      <div class="modal-section">
  ...
  `}function Wc(){const e=!!Qe,t=!!Ke,n=Ke?.rows||[],r=Ke?.rejected||[],o=Ke?.duplicates||[],c=n.length+o.length;return`
    <div class="modal-form">
      ...
      <div class="csv-source-grid">
        ...
        <div class="form-group">
          ...
          <select id="modal-csv-account">${vn(Vn,!1)}</select>
        </div>
      </div>
      <div class="form-group">
        <label for="modal-csv-text">CSV data</label>
        <textarea id="modal-csv-text" rows="7" placeholder="date,description,amount,category,scope">${L(qn)}</textarea>
      </div>
      ${e?`
        <div class="modal-section">
          <div class="ui-title">Detected columns · ${Cc(Qe?.delimiter||",")} separated</div>
          <div class="csv-columns">${Qe?.headers.map(u=>`<code>${L(u)}</code>`).join("")}</div>
          ${kn?`<div class="fin-compact-empty">Saved mapping: ${L(kn)}</div>`:""}
          <div class="csv-mapping-grid">
            <div class="form-group"><label for="modal-csv-map-date">Date *</label><select id="modal-csv-map-date">${jn(Ft.date,"Choose date column")}</select></div>
            <div class="form-group"><label for="modal-csv-map-description">Description *</label><select id="modal-csv-map-description">${jn(Ft.description,"Choose description column")}</select></div>
            <div class="form-group"><label for="modal-csv-map-amount">Signed amount</label><select id="modal-csv-map-amount">${jn(Ft.amount)}</select></div>
            <div class="form-group"><label for="modal-csv-map-debit">Debit</label><select id="modal-csv-map-debit">${jn(Ft.debit)}</select></div>
            <div class="form-group"><label for="modal-csv-map-credit">Credit</label><select id="modal-csv-map-credit">${jn(Ft.credit)}</select></div>
            <div class="form-group"><label for="modal-csv-map-category">Category</label><select id="modal-csv-map-category">${jn(Ft.category)}</select></div>
            <div class="form-group"><label for="modal-csv-map-scope">Scope</label><select id="modal-csv-map-scope">${jn(Ft.scope)}</select></div>
            <div class="form-group"><label for="modal-csv-default-category">Default category</label><input id="modal-csv-default-category" value="${L(Hn)}" /></div>
            <div class="form-group"><label for="modal-csv-default-scope">Default scope</label><select id="modal-csv-default-scope">${nn(Wn)}</select></div>
          </div>
        </div>
      `:""}
      ${gn?`<div class="fin-compact-empty" role="alert">${L(gn)}</div>`:""}
      ${t?`
        <div class="modal-section">
          ...
          ${o.length?`
            <div class="csv-validation-list">
              ...
              <label><input type="radio" name="modal-csv-duplicate-policy" value="skip"${Ai==="skip"?" checked":""} /> Skip duplicates</label>
              <label><input type="radio" name="modal-csv-duplicate-policy" value="import"${Ai==="import"?" checked":""} /> Import duplicates anyway</label>
  ...
  `}function Gc(){const e=ci,t=e?.counts||{},n=e?.warnings||[];return`
    <div class="modal-form">
      ...
      ${e?.valid?`
        <div class="backup-preview-card">
          ...
          <div><span>Exported</span><strong>${hn(e.exportedAt)}</strong></div>
          <div><span>Latest event</span><strong>${hn(e.latestLocalEventAt)}</strong></div>
  ...
  `}function vn(e="",t=!0){const n=te.getFinancialReadModel().fiatAccounts||[];return!n.length&&!t?'<option value="">Operating cash (created on save)</option>':`${t?'<option value="">All accounts</option>':'<option value="">Choose an account</option>'}${n.map(o=>`
    <option value="${L(o.id)}"${String(o.id)===e?" selected":""}>${L(o.name)} · ${L(o.scope||"shared")}</option>
  `).join("")}`}function Kc(e){const t=String(e||"").trim();if(t)return t;try{const n=String(localStorage.getItem("finance-master.layout.treasury-project")||"").trim();return!n||n==="all"||n==="unassigned"?"":(te.getFinancialReadModel().projectProfiles||[]).some(o=>String(o.id)===n&&String(o.status||"active")!=="archived")?n:""}catch{return""}}function di(e){const t=Kc(e);return`<option value="">No project</option>${(te.getFinancialReadModel().projectProfiles||[]).filter(r=>String(r.status||"active")!=="archived").map(r=>`
    <option value="${L(r.id)}"${String(r.id)===t?" selected":""}>${L(r.name)}${r.clientOrPurpose?` · ${L(r.clientOrPurpose)}`:""}</option>
  `).join("")}`}function Yc(e=""){const t=(te.getFinancialReadModel().projectProfiles||[]).find(n=>String(n.id)===e);return`
    <div class="modal-form">
  ...
  `}function Qc(e=""){const t=(te.getFinancialReadModel().pipelineDeals||[]).find(b=>String(b.id)===e),n=String(t?.status||"expected").toLowerCase(),r=t?.probability??Pc[n]??.6,o=t&&Number.isFinite(Number(t.netAmount))?t.netAmount:t?.value,c=t&&Number.isFinite(Number(t.vatRate))?t.vatRate:"",u=String(t?.incomeType||"one_off"),m=u==="retainer"||u==="recurring",y=t&&t.durationValue!==null&&t.durationValue!==void 0&&String(t.durationValue).trim()!==""&&Number.isFinite(Number(t.durationValue))?Number(t.durationValue):"",h=String(t?.durationUnit||"months");return`
    <div class="modal-form">
      ...
      <div class="modal-grid-two">
        ...
        <div class="form-group"><label for="modal-income-date">Expected date</label><input id="modal-income-date" type="date" value="${L(t?.expectedDateISO||an())}" /></div>
        <div class="form-group"><label for="modal-income-status">Status</label><select id="modal-income-status">${Tr.map(b=>`<option value="${b}"${n===b?" selected":""}>${b}</option>`).join("")}</select></div>
        ...
        <div class="form-group"><label for="modal-income-scope">Scope</label><select id="modal-income-scope">${nn(String(t?.scope||"business"))}</select></div>
        <div class="form-group"><label for="modal-income-project">Project plan</label><select id="modal-income-project">${di(t?String(t.projectId||""):void 0)}</select></div>
      </div>
      <div class="form-group"><label for="modal-income-account">Settlement account</label><select id="modal-income-account">${vn(String(t?.destinationAccountId||""))}</select></div>
      ${Xe("income",!!t)}
    </div>
  `}function Zc(e=""){const t=(te.getFinancialReadModel().fiatAccounts||[]).find(n=>String(n.id)===e);return`
    <div class="modal-form">
      ...
      <div class="modal-grid-two">
        <div class="form-group"><label for="modal-fiat-scope">Scope</label><select id="modal-fiat-scope">${nn(String(t?.scope||"business"))}</select></div>
        <div class="form-group"><label for="modal-fiat-project">Project plan</label><select id="modal-fiat-project">${di(t?String(t.projectId||""):void 0)}</select></div>
      ...
      <div class="modal-actions">${Ki("deactivateFiatAccount",!!t)}<span class="modal-actions-spacer"></span>${Xe("fiatAccount",!!t).replace('<div class="modal-actions">',"").replace("</div>","")}</div>
    </div>
  `}function Jc(e=""){const t=(te.getFinancialReadModel().reserveBuckets||[]).find(n=>String(n.id)===e);return`
    <div class="modal-form">
      ...
      <div class="modal-grid-two">
        ...
        <div class="form-group"><label for="modal-reserve-scope">Scope</label><select id="modal-reserve-scope">${nn(String(t?.scope||"shared"))}</select></div>
        <div class="form-group"><label for="modal-reserve-project">Project plan</label><select id="modal-reserve-project">${di(t?String(t.projectId||""):void 0)}</select></div>
      ...
      <div class="modal-actions">${Ki("deactivateReserveBucket",!!t)}<span class="modal-actions-spacer"></span>${Xe("reserveBucket",!!t).replace('<div class="modal-actions">',"").replace("</div>","")}</div>
    </div>
  `}function Xc(){return`
    <div class="modal-form">
  ...
  `}function el(e=""){const t=(te.getFinancialReadModel().recurringExpenses||[]).find(r=>String(r.id)===e);let n=t?.monthlyAmount||"";return t&&t.monthlyAmount&&(t.frequency==="quarterly"&&(n=t.monthlyAmount*3),t.frequency==="semi-annually"&&(n=t.monthlyAmount*6),t.frequency==="annually"&&(n=t.monthlyAmount*12)),`
    <div class="modal-form">
      ...
      <div class="modal-grid-two">
        ...
        <div class="form-group"><label for="modal-expense-scope">Scope</label><select id="modal-expense-scope">${nn(String(t?.scope||"personal"))}</select></div>
        <div class="form-group"><label for="modal-expense-project">Project plan</label><select id="modal-expense-project">${di(t?String(t.projectId||""):void 0)}</select></div>
      </div>
      ...
      <div class="modal-actions">${Ki("deactivateRecurringExpense",!!t)}<span class="modal-actions-spacer"></span>${Xe("expense",!!t).replace('<div class="modal-actions">',"").replace("</div>","")}</div>
    </div>
  `}function tl(e,t=""){const n=te.getFinancialReadModel().debtAccounts||[];if(e==="debtPayment")return n.length?`
      <div class="modal-form">
    ...
    <div class="modal-form">
      ...
      <div class="form-group"><label for="modal-debt-scope">Scope</label><select id="modal-debt-scope">${nn(String(r?.scope||"business"))}</select></div>
      <div class="form-group"><label for="modal-debt-project">Project plan</label><select id="modal-debt-project">${di(r?String(r.projectId||""):void 0)}</select></div>
      <div class="modal-actions">${Ki("deactivateDebtAccount",!!r)}<span class="modal-actions-spacer"></span>${Xe("debtAdd",!!r).replace('<div class="modal-actions">',"").replace("</div>","")}</div>
    </div>
  `}function Rr(e){return((te.computeFinanceContext(!0).treasury||{}).obligations||[]).find(n=>String(n.id||"")===String(e||""))||null}function nl(e=""){const t=Rr(e);return`
    <div class="modal-form">
      <h2 id="modal-title">Mark obligation paid</h2>
      <p class="modal-copy">${L(t?.title||"Obligation")} · ${Pe(t?.amount)} · due ${hn(t?.dueDate)}</p>
      <input id="modal-obligation-id" type="hidden" value="${L(e)}" />
      <div class="modal-grid-two">
        <div class="form-group"><label for="modal-obligation-account">Paid from account</label><select id="modal-obligation-account">${vn("",!1)}</select></div>
        <div class="form-group"><label for="modal-obligation-paid-at">Payment date</label><input id="modal-obligation-paid-at" type="date" value="${L(String(t?.dueDate||an()).slice(0,10))}" /></div>
  ...
  `}function il(e=""){const t=Rr(e);return`
    <div class="modal-form">
      <h2 id="modal-title">Defer obligation</h2>
      <p class="modal-copy">${L(t?.title||"Obligation")} · current due date ${hn(t?.dueDate)}</p>
      <input id="modal-obligation-id" type="hidden" value="${L(e)}" />
      <div class="form-group"><label for="modal-obligation-deferred-until">New due date</label><input id="modal-obligation-deferred-until" type="date" value="${an()}" /></div>
  ...
  `}function Or(e){return(te.getFinancialReadModel().transactions||[]).find(t=>String(t.id)===String(e||"")||String(t.transactionEntityId||"")===String(e||""))||null}function al(e){const t=String(e?.source||"").trim();return e?.importBatchId||e?.sourceFile?"Imported from CSV":t==="obligation.review"?"Created from obligation review":t==="pipeline-settlement"?"Created from income settlement":t==="demo"?"Sample record":t==="manual"||t==="manual-ledger"?"Added manually":t?t.replace(/[._-]/g," "):"Local record"}function rl(e){const t=String(e?.importBatchId||"").trim();return t&&(te.getImportState().batches||[]).find(r=>String(r.id||"")===t)||null}function ol(e){if(!e)return[];const t=Number(e.importedCount??(Array.isArray(e.fingerprints)?e.fingerprints.length:0))||0,n=Number(e.duplicateCount||0),r=Number(e.duplicateImportedCount||0),o=Number(e.rejectedCount||0),c=(te.getFinancialReadModel().transactions||[]).filter(b=>String(b.importBatchId||"")===String(e.id||"")).length,u=e.duplicatePolicy==="import"?"duplicates imported":"duplicates skipped",m=`${Pe(e.incomeTotal||0)} in · ${Pe(e.expenseTotal||0)} out`,f=String(e.dateFrom||""),y=String(e.dateTo||""),h=f&&y?f===y?f:`${f} to ${y}`:"";return[["CSV batch",`${t} imported · ${n} duplicate${n===1?"":"s"} (${u}) · ${o} rejected`],["Batch totals",m],["Batch range",h],["Undo state",c>0?`${c} active record${c===1?"":"s"}`:"Undo applied"],["Duplicates included",r?String(r):""]]}function sl(e){const t=rl(e);return[["Category",String(e?.categoryId||"uncategorized")],["Scope",String(e?.scope||"shared")],["Source",al(e)],["Review",String(e?.reviewStatus||"clear").replace(/[._-]/g," ")],["Source file",String(e?.sourceFile||"")],["Import batch",String(e?.importBatchId||"")],...ol(t),["Fingerprint",String(e?.fingerprint||"")],["Linked income",String(e?.linkedIncomeTitle||e?.linkedIncomeId||"")],["Linked obligation",String(e?.linkedObligationTitle||e?.obligationTitle||e?.obligationId||"")],["Linked debt",String(e?.linkedDebtTitle||e?.linkedDebtId||"")],["Linked reserve",String(e?.linkedReserveId||"")],["Reversal",e?.reversalOf?`Reversal of ${String(e.reversalOf)}`:e?.reversedBy?`Reversed by ${String(e.reversedBy)}`:""],["Record ID",String(e?.id||"")],["Transaction entity",String(e?.transactionEntityId||"")],["Created timestamp",String(e?.timestamp||"")]].filter((r,o,c)=>r[1].trim()&&c.findIndex(u=>u[0]===r[0]&&u[1]===r[1])===o)}function cl(e=""){return`<option value="">Choose obligation</option>${((te.computeFinanceContext(!0).treasury||{}).obligations||[]).filter(n=>String(n.status||"")!=="paid"&&String(n.type||"")!=="debt").map(n=>`
    <option value="${L(n.id)}"${String(n.id)===e?" selected":""}>${L(n.title)} · ${hn(n.dueDate)} · ${Pe(n.amount)}</option>
  `).join("")}`}function ll(e,t){const n=Date.parse(String(e||"")),r=Date.parse(String(t||""));return!Number.isFinite(n)||!Number.isFinite(r)?Number.POSITIVE_INFINITY:Math.abs(n-r)/864e5}function oi(e){return String(e||"").toLowerCase().split(/[^a-z0-9]+/).map(t=>t.trim()).filter(t=>t.length>=4)}function va(e,t,n,r){const o=String(t||"").trim();if(!o||o.toLowerCase()==="uncategorized")return;const c=e.get(o);(!c||r>c.score)&&e.set(o,{category:o,reason:n,score:r})}function dl(e){if(!e)return[];const t=te.getFinancialReadModel(),n=String(e.description||"").toLowerCase(),r=new Set(oi(n)),o=new Map;return(t.transactions||[]).forEach(c=>{if(String(c.id||"")===String(e.id||""))return;const u=String(c.categoryId||"");if(!u||u.toLowerCase()==="uncategorized")return;const m=oi(c.description).filter(f=>r.has(f));m.length?va(o,u,"Used on similar ledger records",4+m.length):oi(u).some(f=>n.includes(f))&&va(o,u,"Category name appears in the description",3)}),(t.recurringExpenses||[]).forEach(c=>{const u=String(c.category||"");oi(u).some(f=>n.includes(f))&&va(o,u,"Matches a recurring obligation",5)}),Array.from(o.values()).sort((c,u)=>u.score-c.score||c.category.localeCompare(u.category)).slice(0,3).map(({category:c,reason:u})=>({category:c,reason:u}))}function ul(e){if(!e||String(e.type)!=="expense.recorded")return[];const t=Math.abs(Number(e.amount)||Number(e.signedAmount)||0),n=new Set(oi(e.description));return((te.computeFinanceContext(!0).treasury||{}).obligations||[]).filter(o=>String(o.status||"")!=="paid"&&String(o.type||"")!=="debt").map(o=>{const c=Math.abs(Number(o.amount)||0),u=Math.abs(c-t),m=ll(e.timestamp,o.dueDate),f=oi(o.title).filter(b=>n.has(b)).length;let y=0;const h=[];return u<.01?(y+=6,h.push("same amount")):u<=Math.max(5,t*.05)&&(y+=3,h.push("similar amount")),m<=3?(y+=4,h.push("near due date")):m<=10&&(y+=2,h.push("close date")),f&&(y+=f*2,h.push("matching description")),{id:String(o.id||""),title:String(o.title||"Obligation"),reason:h.join(" + ")||"possible obligation",score:y}}).filter(o=>o.id&&o.score>0).sort((o,c)=>c.score-o.score||o.title.localeCompare(c.title)).slice(0,3).map(({id:o,title:c,reason:u})=>({id:o,title:c,reason:u}))}function ml(e=""){const t=Or(e),n=dl(t),r=String(t?.linkedIncomeId||""),o=(te.getFinancialReadModel().pipelineDeals||[]).filter(f=>String(f.id||"")===r||!["paid","cancelled","lost","deleted"].includes(String(f.status||"").toLowerCase())),c=te.getFinancialReadModel().reserveBuckets||[],u=te.getFinancialReadModel().debtAccounts||[],m=sl(t);return`
    <div class="modal-form">
      <h2 id="modal-title">Review transaction</h2>
      <p class="modal-copy">${L(t?.description||"Transaction")} · ${Pe(t?.amount)} · ${hn(t?.timestamp)}</p>
      ...
      <div class="modal-grid-two">
        ...
        <div class="form-group"><label for="modal-review-transaction-scope">Scope</label><select id="modal-review-transaction-scope">${nn(String(t?.scope||"business"))}</select></div>
      </div>
      <div class="modal-grid-two">
      ...
      ${n.length?`
        <div class="csv-validation-list">
          ...
          ${n.map(f=>`
            <button class="fin-mini-btn" type="button" data-action="chooseTransactionCategorySuggestion" data-action-args="'${L(Hi(f.category))}'">${L(f.category)}</button>
      ...
      ${e?`
        <div class="modal-danger-zone">
          ...
          <button class="fin-mini-btn fin-mini-btn--danger" type="button" data-action="deleteTransaction" data-action-args="'${L(Hi(e))}'">Reverse transaction</button>
        </div>
      `:""}
      ${Xe("transactionReview")}
    </div>
  `}function pl(e=""){const t=Or(e),n=ul(t);return`
    <div class="modal-form">
      <h2 id="modal-title">Match payment to obligation</h2>
      <p class="modal-copy">${L(t?.description||"Payment")} · ${Pe(t?.amount)} · ${hn(t?.timestamp)}</p>
      <input id="modal-match-transaction-id" type="hidden" value="${L(e)}" />
      <div class="form-group"><label for="modal-match-obligation-id">Obligation</label><select id="modal-match-obligation-id">${cl("")}</select></div>
      ${n.length?`
        <div class="csv-validation-list">
          <strong>Suggested matches</strong>
          ${n.map(r=>`
            <button class="fin-mini-btn" type="button" data-action="choosePaymentMatchSuggestion" data-action-args="'${L(Hi(r.id))}'">${L(r.title)}</button>
  ...
  `}function fl(e=""){const t=(te.getFinancialReadModel().pipelineDeals||[]).find(r=>String(r.id)===e),n=String(t?.status||"expected").toLowerCase();return`
    <div class="modal-form">
      <h2 id="modal-title">Review pipeline item</h2>
      <p class="modal-copy">${L(t?.title||"Pipeline item")} · ${Pe(t?.value)}</p>
      <input id="modal-pipeline-review-id" type="hidden" value="${L(e)}" />
      <div class="modal-grid-two">
        <div class="form-group"><label for="modal-pipeline-review-status">Status</label><select id="modal-pipeline-review-status">${Tr.map(r=>`<option value="${r}"${n===r?" selected":""}>${r}</option>`).join("")}</select></div>
        ...
        <div class="form-group"><label for="modal-pipeline-review-date">Expected date</label><input id="modal-pipeline-review-date" type="date" value="${L(t?.expectedDateISO||an())}" /></div>
        <div class="form-group"><label for="modal-pipeline-review-account">Settlement account</label><select id="modal-pipeline-review-account">${vn(String(t?.destinationAccountId||""))}</select></div>
      </div>
  ...
  `}function gl(e=""){const t=(te.getFinancialReadModel().debtAccounts||[]).find(m=>String(m.id)===e),n=t?.planType||"regular",r=t?.paymentFrequency||t?.frequency||"monthly",o=t?.planStatus||"active",u=(t?.installments||[]).map((m,f)=>`
  ...
  `).join("");return`
    <div class="modal-form">
      ...
      <div id="modal-debt-plan-regular-section" style="display: ${n==="regular"?"block":"none"};">
        ...
        <div class="form-group"><label for="modal-debt-plan-due-date">Next due date</label><input id="modal-debt-plan-due-date" type="date" value="${L(t?.dueDate||an())}" /></div>
      </div>
  ...
  `}function vl(e,t=""){return e==="quickAdd"?Tc():e==="transaction"?Uc(t):e==="financeOverview"?Lc():e==="weeklyReview"?qc():e==="goals"?Vc():e==="goal"?Hc(t):e==="csvImport"?Wc():e==="backupRestore"?Gc():e==="destructiveConfirm"?Rc():e==="projectProfile"?Yc(t):e==="settleIncome"?zc(t):e==="income"?Qc(t):e==="fiatAccount"?Zc(t):e==="reserveBucket"?Jc(t):e==="allocateReserves"?Xc():e==="web3Position"||e==="defiPosition"?'<div class="modal-form"><h2 id="modal-title">Postponed</h2><p class="modal-copy">Market portfolio tracking is outside the focused treasury MVP.</p></div>':e==="expense"?el(t):e==="debtAdd"||e==="debtPayment"?tl(e,t):e==="obligationPayment"?nl(t):e==="obligationDefer"?il(t):e==="transactionReview"?ml(t):e==="paymentMatch"?pl(t):e==="pipelineReview"?fl(t):e==="debtPlan"?gl(t):'<div class="modal-form"><h2 id="modal-title">Nothing to edit</h2></div>'}function ht(e,t={}){!Tt||!Dn||(Mi(),!Tt.classList.contains("active")&&document.activeElement instanceof HTMLElement&&(Na=document.activeElement),Tt.dataset.type=e,Tt.classList.add("active"),Tt.setAttribute("aria-hidden","false"),Dn.innerHTML=vl(e,typeof t=="string"?t:String(t.id||"")),window.requestAnimationFrame(()=>{Dn.querySelector('[data-autofocus], input:not([type="hidden"]):not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled])')?.focus()}))}function vt(e){li=e,ht("destructiveConfirm")}function bt(){!Tt||!Dn||(Tt.classList.remove("active"),Tt.setAttribute("aria-hidden","true"),Dn.innerHTML="",li=null,Na?.focus(),Na=null)}function Bn(e,t){try{te.appendFinanceEvent(e,{source:t}),bt()}catch(n){ye(n instanceof Error?n.message:"Could not save this finance entry.")}}function _r(e){const t=T(`${e}-type`)||"expense",n=T(`${e}-desc`),r=Math.abs(Number(T(`${e}-amount`))),o=T(`${e}-account`),u=!((te.getFinancialReadModel().fiatAccounts||[]).length>0)&&t!=="transfer";if(!Number.isFinite(r)||r<=0||!o&&!u)return ye(u?"Add a positive amount.":"Add a positive amount and an account."),!1;try{return t==="transfer"?te.recordTransfer({description:n,amount:r,timestamp:cr(T(`${e}-date`)),fromAccountId:o,toAccountId:T(`${e}-to-account`),categoryId:T(`${e}-category`)||"transfer",scope:T(`${e}-scope`),projectId:T(`${e}-project`)}):te.recordLedgerTransaction({type:t==="income"||t==="adjustment"?t:"expense",description:n,amount:r,timestamp:cr(T(`${e}-date`)),accountId:o,categoryId:T(`${e}-category`)||(t==="income"?"client-income":t==="adjustment"?"adjustment":"uncategorized"),scope:T(`${e}-scope`),direction:T(`${e}-direction`)==="decrease"?"decrease":"increase",projectId:T(`${e}-project`)}),bt(),!0}catch(m){return ye(m instanceof Error?m.message:"Could not add this transaction."),!1}}function ha(){qn=T("modal-csv-text")||qn,Vn=T("modal-csv-account")||Vn,Hn=T("modal-csv-default-category")||Hn,Wn=T("modal-csv-default-scope")||Wn,Ai=document.querySelector('input[name="modal-csv-duplicate-policy"]:checked')?.value==="import"?"import":"skip",Qe&&(Ft={date:T("modal-csv-map-date"),description:T("modal-csv-map-description"),amount:T("modal-csv-map-amount"),debit:T("modal-csv-map-debit"),credit:T("modal-csv-map-credit"),category:T("modal-csv-map-category"),scope:T("modal-csv-map-scope")})}function hl(){const e=te.exportBackup(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=document.createElement("a");n.href=URL.createObjectURL(t),n.download=`finance-master-backup-${an()}.json`,n.click(),te.recordBackupExport(e.exportedAt),URL.revokeObjectURL(n.href)}function bl(){const e=new Blob([te.exportTransactionsCsv()],{type:"text/csv;charset=utf-8"}),t=document.createElement("a");t.href=URL.createObjectURL(e),t.download=`finance-master-transactions-${an()}.csv`,t.click(),URL.revokeObjectURL(t.href)}function yl(e){const t=te.getFinanceSettings().baseCurrency,n=new Date().toISOString();if(e==="transaction"){_r("modal-fast-txn");return}if(e==="income"){const r=Number(T("modal-income-amount")),o=String(T("modal-income-vat-rate")||"").trim(),c=o?Number(o):0,u=Number(T("modal-income-probability")),m=T("modal-income-type")||"one_off",f=String(T("modal-income-duration-value")||"").trim(),y=f?Number(f):null,h=T("modal-income-duration-unit")||"months";if(!T("modal-income-title")||!Number.isFinite(r)||r===0||!Number.isFinite(u)||u<0||u>1||!Number.isFinite(c)||c<0||c>100){ye("Add an income source, a non-zero amount, an optional VAT rate between 0 and 100, and a probability between 0 and 1.");return}if((m==="retainer"||m==="recurring")&&f&&(!Number.isFinite(Number(y))||Number(y)<=0||!["months","hours","times"].includes(h))){ye("For retainer or recurring income, duration must be a positive number with months, hours, or times.");return}const b=Math.abs(r),_=Math.round(b*(c/100)*100)/100,B=Math.round((b+_)*100)/100,N=(m==="retainer"||m==="recurring")&&y?{durationValue:y,durationUnit:h}:{};Bn({type:"pipeline.created",amount:B,currency:t,timestamp:n,related_entity_id:T("modal-income-id")||yi("pipeline"),metadata:{title:T("modal-income-title"),value:B,netAmount:b,vatRate:c,vatAmount:_,grossAmount:B,probability:u,status:T("modal-income-status"),stage:T("modal-income-status"),scenarioInclusion:T("modal-income-scenario")||"realistic",incomeType:m,...N,expectedDateISO:T("modal-income-date"),destinationAccountId:T("modal-income-account"),scope:T("modal-income-scope"),projectId:T("modal-income-project")||void 0}},"modal.income");return}if(e==="fiatAccount"){const r=Number(T("modal-fiat-balance"));if(!T("modal-fiat-name")||!Number.isFinite(r)){ye("Add an account name and a valid balance.");return}const o=T("modal-fiat-bucket")||"available";Bn({type:"asset.account_set",amount:r,currency:t,timestamp:n,related_entity_id:T("modal-fiat-id")||yi("cash"),metadata:{name:T("modal-fiat-name"),balance:r,active:!0,scope:T("modal-fiat-scope"),projectId:T("modal-fiat-project")||void 0,bucket:o,reserved:o!=="available"}},"modal.fiatAccount");return}if(e==="reserveBucket"){let r=T("modal-reserve-name"),o=Number(T("modal-reserve-target"));const c=Number(T("modal-reserve-current"))||0;if((!Number.isFinite(o)||o<=0)&&c>0){const u=r.match(/^(.*[^\s\d])(\d+(?:\.\d+)?)$/);u&&(r=u[1].trim(),o=Number(u[2]))}if(!r||!Number.isFinite(o)||o<=0||c<0){ye("Add a name, a positive target amount, and a valid current amount.");return}Bn({type:"asset.reserve_set",amount:o,currency:t,timestamp:n,related_entity_id:T("modal-reserve-id")||yi("reserve"),metadata:{name:r,targetAmount:o,currentAmount:c,purpose:T("modal-reserve-purpose"),scope:T("modal-reserve-scope"),projectId:T("modal-reserve-project")||void 0,priority:T("modal-reserve-priority"),active:!0}},"modal.reserveBucket");return}if(e==="allocateReserves"){const r=Number(T("modal-allocate-amount")),o=T("modal-allocate-bucket");if(!o||!Number.isFinite(r)||r<=0){ye("Enter a valid amount to allocate.");return}const c=(te.getFinancialReadModel().reserveBuckets||[]).find(u=>String(u.id)===o);if(!c){ye("Choose an existing reserve bucket before allocating cash.");return}Bn({type:"asset.reserve_allocated",amount:r,currency:t,timestamp:n,related_entity_id:o,metadata:{currentAmount:(Number(c.currentAmount)||0)+r}},"modal.allocateReserves");return}if(e==="expense"){const r=Math.abs(Number(T("modal-expense-amount"))),o=T("modal-expense-frequency")||"monthly";let c=r;o==="quarterly"&&(c=r/3),o==="semi-annually"&&(c=r/6),o==="annually"&&(c=r/12);const u=Number(T("modal-expense-due-day"));if(!T("modal-expense-category")||!Number.isFinite(r)||r<=0||!Number.isFinite(u)||u<1||u>28){ye("Add a cost name, positive amount, and due day from 1 to 28.");return}Bn({type:"expense.recurring_set",amount:r,currency:t,timestamp:n,related_entity_id:T("modal-expense-id")||yi("expense"),metadata:{category:T("modal-expense-category"),monthlyAmount:c,essential:Si("modal-expense-essential"),active:!0,dueDay:u,frequency:o,scope:T("modal-expense-scope"),projectId:T("modal-expense-project")||void 0}},"modal.expense");return}if(e==="debtAdd"){const r=Math.abs(Number(T("modal-debt-amount")));if(!T("modal-debt-name")||!Number.isFinite(r)||r<=0){ye("Add a debt name and a positive amount.");return}Bn({type:"debt.added",amount:r,currency:t,timestamp:n,related_entity_id:T("modal-debt-id")||yi("debt"),metadata:{name:T("modal-debt-name"),scope:T("modal-debt-scope"),projectId:T("modal-debt-project")||void 0}},"modal.debtAdd");return}if(e==="projectProfile"){try{te.saveProjectProfile({id:T("modal-project-id")||void 0,name:T("modal-project-name"),clientOrPurpose:T("modal-project-purpose"),color:T("modal-project-color"),notes:T("modal-project-notes"),status:"active"}),bt()}catch(r){ye(r instanceof Error?r.message:"Could not save this project plan.")}return}if(e==="debtPayment"){const r=Math.abs(Number(T("modal-debt-payment-amount")));if(!T("modal-debt-payment-id")||!Number.isFinite(r)||r<=0){ye("Choose a debt item and enter a positive payment amount.");return}Bn({type:"debt.payment_made",amount:r,currency:t,timestamp:n,related_entity_id:T("modal-debt-payment-id"),metadata:{}},"modal.debtPayment");return}if(e==="obligationPayment"){const r=Math.abs(Number(T("modal-obligation-amount")));if(!T("modal-obligation-id")||!T("modal-obligation-account")||!Number.isFinite(r)||r<=0){ye("Choose an obligation, payment account, and positive amount.");return}try{te.reviewObligation({id:T("modal-obligation-id"),status:"paid",accountId:T("modal-obligation-account"),paidAt:T("modal-obligation-paid-at"),amount:r,notes:T("modal-obligation-notes")}),bt()}catch(o){ye(o instanceof Error?o.message:"Could not mark this obligation paid.")}return}if(e==="obligationDefer"){if(!T("modal-obligation-id")||!T("modal-obligation-deferred-until")){ye("Choose an obligation and a new due date.");return}try{te.reviewObligation({id:T("modal-obligation-id"),status:"deferred",deferredUntil:T("modal-obligation-deferred-until"),notes:T("modal-obligation-notes")}),bt()}catch(r){ye(r instanceof Error?r.message:"Could not defer this obligation.")}return}if(e==="transactionReview"){if(!T("modal-review-transaction-id")||!T("modal-review-transaction-category")){ye("Choose a transaction category before clearing this item.");return}try{te.reviewTransaction({id:T("modal-review-transaction-id"),categoryId:T("modal-review-transaction-category"),scope:T("modal-review-transaction-scope"),notes:T("modal-review-transaction-notes"),linkedIncomeId:T("modal-review-linked-income"),linkedReserveId:T("modal-review-linked-reserve"),linkedDebtId:T("modal-review-linked-debt")}),bt()}catch(r){ye(r instanceof Error?r.message:"Could not categorize this transaction.")}return}if(e==="paymentMatch"){if(!T("modal-match-transaction-id")||!T("modal-match-obligation-id")){ye("Choose a payment and an obligation to match.");return}try{te.matchTransactionToObligation({transactionId:T("modal-match-transaction-id"),obligationId:T("modal-match-obligation-id"),notes:T("modal-match-notes")}),bt()}catch(r){ye(r instanceof Error?r.message:"Could not match this payment.")}return}if(e==="pipelineReview"){const r=Number(T("modal-pipeline-review-probability"));if(!T("modal-pipeline-review-id")||!T("modal-pipeline-review-date")||!Number.isFinite(r)||r<0||r>1){ye("Choose a pipeline item, expected date, and probability between 0 and 1.");return}try{te.updatePipelineReview({id:T("modal-pipeline-review-id"),status:T("modal-pipeline-review-status"),probability:r,expectedDateISO:T("modal-pipeline-review-date"),destinationAccountId:T("modal-pipeline-review-account"),notes:T("modal-pipeline-review-notes")}),bt()}catch(o){ye(o instanceof Error?o.message:"Could not update this pipeline item.")}return}if(e==="debtPlan"){const r=T("modal-debt-plan-type")||"regular",o=T("modal-debt-plan-status")||"active",c=T("modal-debt-plan-frequency"),u=Number(T("modal-debt-plan-minimum")),m=T("modal-debt-plan-due-date"),f=T("modal-debt-plan-start-date"),y=T("modal-debt-plan-end-date"),h=T("modal-debt-plan-custom-pressure")?Number(T("modal-debt-plan-custom-pressure")):null,b=T("modal-debt-plan-note"),_=[];if(r==="custom"){const B=document.querySelectorAll(".modal-debt-plan-inst-date"),N=document.querySelectorAll(".modal-debt-plan-inst-amount");for(let x=0;x<B.length;x++)B[x].value&&Number(N[x].value)>0&&_.push({date:B[x].value,amount:Number(N[x].value)});if(_.length===0){ye("Add at least one valid installment for a custom plan.");return}}else if(o==="active"&&(!m||!Number.isFinite(u)||u<=0)){ye("Add a due date and positive minimum payment.");return}if(o==="starts_later"&&!f){ye("Choose when this payment plan starts.");return}if(h!==null&&(!Number.isFinite(h)||h<0)){ye("Add a valid custom monthly pressure or leave it empty.");return}if(!T("modal-debt-plan-id")){ye("Invalid debt ID.");return}try{te.saveDebtPlan({id:T("modal-debt-plan-id"),dueDate:m||_[0]?.date||new Date().toISOString(),minimumPayment:u||_[0]?.amount||0,paymentPlanNote:b,planType:r,planStatus:o,startDate:f,endDate:y,customMonthlyPressure:h,frequency:c,installments:_,includeInBurnRate:Si("modal-debt-plan-include-burn"),includeInSafeToSpend:Si("modal-debt-plan-include-safe"),includeInRunway:Si("modal-debt-plan-include-runway")}),bt()}catch(B){ye(B instanceof Error?B.message:"Could not save this debt plan.")}return}if(e==="goal"){try{te.saveGoal({id:T("modal-goal-id")||void 0,name:T("modal-goal-name"),type:T("modal-goal-type")==="savings"?"savings":"buffer",targetAmount:Number(T("modal-goal-target")),targetDate:T("modal-goal-date")||void 0,scope:T("modal-goal-scope"),linkedAccountIds:[...document.querySelectorAll('[id^="modal-goal-account-"]:checked')].map(r=>r.value)}),ht("goals")}catch(r){ye(r instanceof Error?r.message:"Could not save this goal.")}return}if(e==="settleIncome"){if(!T("modal-settle-account")){ye("Choose a settlement account before marking this item as paid.");return}try{te.markPipelineItemPaid(T("modal-settle-id"),{destinationAccountId:T("modal-settle-account")}),bt()}catch(r){ye(r instanceof Error?r.message:"Could not mark this income as paid.")}}}function wl(e){const t=[];return e.replace(/'((?:\\.|[^'])*)'/g,(n,r)=>(t.push(r.replace(/\\'/g,"'").replace(/\\\\/g,"\\")),"")),t}function Sl(e){const t=e.split(".").reduce((n,r)=>!n||typeof n!="object"?null:n[r],window);return typeof t=="function"?t:null}function _i(e,t){const n=T(t);n&&vt({action:e,targetId:n,title:"Deactivate item",copy:"This archives the selected item from active finance calculations while keeping the event history.",phrase:"DEACTIVATE ITEM",buttonLabel:"Deactivate item"})}Object.assign(window,{openEditModal:ht,requestDestructiveConfirmation:vt,closeModal:bt,toggleQuickActionMenu:_c,closeQuickActionMenu:Mi,saveFinanceModal:yl,addTransaction:()=>{_r("modal-txn")&&ht("financeOverview")},refreshTransactionsModal:()=>{Ie.search=T("modal-filter-search"),Ie.accountId=T("modal-filter-account"),Ie.scope=T("modal-filter-scope")||"all",Ie.categoryId=T("modal-filter-category"),Ie.type=T("modal-filter-type")||"all",Ie.reviewStatus=T("modal-filter-review-status")||"all",Ie.dateFrom=T("modal-filter-date-from"),Ie.dateTo=T("modal-filter-date-to"),ht("financeOverview")},deleteTransaction:e=>{e&&vt({action:"reverseTransaction",targetId:e,source:"modal.transaction.reverse",title:"Reverse transaction",copy:"This reverses the transaction and its linked account balance update.",phrase:"REVERSE TRANSACTION",buttonLabel:"Reverse transaction",renderAfter:!0})},markAsPaid:e=>{ht("settleIncome",{id:e})},deleteInvoice:e=>{if(!e)return;const t=(te.getFinancialReadModel().invoices||[]).find(n=>String(n.id)===e);vt({action:"deleteInvoice",targetId:e,reverseSettlement:String(t?.status||"").toLowerCase()==="paid",title:"Archive income entry",copy:"This archives the selected pipeline or settlement entry. If it is settled, the linked settlement can be reversed as part of the archive.",phrase:"ARCHIVE INCOME ENTRY",buttonLabel:"Archive entry"})},markObligationNeedsReview:e=>{try{te.reviewObligation({id:e,status:"needs_review"})}catch(t){window.alert(t instanceof Error?t.message:"Could not update this obligation.")}},cancelPipelineFromReview:e=>{e&&vt({action:"cancelPipelineItem",targetId:e,source:"Cancelled during Review.",title:"Cancel pipeline item",copy:"This removes the selected pipeline item from expected income and forecast assumptions.",phrase:"CANCEL PIPELINE ITEM",buttonLabel:"Cancel pipeline item",renderAfter:!0})},chooseTransactionCategorySuggestion:e=>{const t=document.getElementById("modal-review-transaction-category");t&&(t.value=e,t.focus())},choosePaymentMatchSuggestion:e=>{const t=document.getElementById("modal-match-obligation-id");t&&(t.value=e,t.focus())},toggleDebtPlanType:e=>{const t=document.getElementById("modal-debt-plan-regular-section"),n=document.getElementById("modal-debt-plan-custom-section");t&&(t.style.display=e==="regular"?"block":"none"),n&&(n.style.display=e==="custom"?"block":"none")},addCustomInstallment:()=>{const e=document.getElementById("modal-debt-plan-custom-list");if(!e)return;const t=e.children.length,n=document.createElement("div");n.className="custom-installment-row modal-grid-two",n.style.cssText="margin-bottom: 0.5rem; display: flex; gap: 0.5rem;",n.dataset.index=String(t),n.innerHTML=`
      <input type="date" class="modal-debt-plan-inst-date" value="${an()}" style="flex: 1;" />
      <input type="number" min="0" step="0.01" class="modal-debt-plan-inst-amount" placeholder="Amount" style="flex: 1;" />
      <button type="button" class="btn-secondary ui-btn ui-btn--secondary" onclick="this.parentElement.remove()" style="flex: 0 0 auto;">X</button>
    `,e.appendChild(n)},archiveProjectProfile:()=>{const e=T("modal-project-id");e&&vt({action:"archiveProjectProfile",targetId:e,title:"Archive project plan",copy:"This hides the project plan from active profile choices while keeping all tagged finance history intact.",phrase:"ARCHIVE PROJECT PLAN",buttonLabel:"Archive project",renderAfter:!0})},deactivateFiatAccount:()=>_i("deactivateFiatAccount","modal-fiat-id"),deactivateReserveBucket:()=>_i("deactivateReserveBucket","modal-reserve-id"),deactivateRecurringExpense:()=>_i("deactivateRecurringExpense","modal-expense-id"),deactivateDebtAccount:()=>_i("deactivateDebtAccount","modal-debt-id"),deleteDebtAccount:e=>{e&&vt({action:"deleteDebtAccount",targetId:e,title:"Delete mistaken debt",copy:"This reverses the selected debt, its payments, and its payment-plan events. Use archive for old debt history you want to keep visible in the record.",phrase:"DELETE DEBT ENTRY",buttonLabel:"Delete debt entry",renderAfter:!0})},pauseDebtPlan:e=>{try{te.setDebtPlanStatus(e,"on_hold"),window.FinancialMode?.render?.()}catch(t){window.alert(t instanceof Error?t.message:"Could not pause this debt plan.")}},reactivateDebtPlan:e=>{try{te.setDebtPlanStatus(e,"active"),window.FinancialMode?.render?.()}catch(t){window.alert(t instanceof Error?t.message:"Could not reactivate this debt plan.")}},completeDebtPlan:e=>{e&&vt({action:"completeDebtPlan",targetId:e,title:"Mark debt plan complete",copy:"This keeps the debt record in history and removes the plan from active monthly pressure.",phrase:"MARK DEBT COMPLETE",buttonLabel:"Mark complete",renderAfter:!0})},archiveDebtPlan:e=>{e&&vt({action:"archiveDebtPlan",targetId:e,title:"Archive debt plan",copy:"This hides the payment plan from active calculations while keeping the liability history available.",phrase:"ARCHIVE DEBT PLAN",buttonLabel:"Archive debt plan",renderAfter:!0})},resetDemoData:()=>{vt({action:"resetDemoData",title:"Restore sample data",copy:"This replaces the current local Finance Master ledger with the fictional sample data.",phrase:"RESTORE SAMPLE DATA",buttonLabel:"Restore sample data"})},deleteDemoData:()=>{vt({action:"deleteDemoData",title:"Delete sample data",copy:"This clears the fictional sample ledger from this browser. Your dashboard will be empty until you add entries or restore a backup.",phrase:"DELETE SAMPLE DATA",buttonLabel:"Delete sample data"})},resetLocalFinanceData:()=>{vt({action:"resetLocalFinanceData",title:"Reset local finance data",copy:"This clears only Finance Master local finance data in this browser, including ledger events, settings, review state, import history, goals, and cached local values.",phrase:"DELETE LOCAL FINANCE DATA",buttonLabel:"Reset local data"})},completeWeeklyReview:()=>{const e=[...document.querySelectorAll(".review-account-check")],t=["modal-review-unresolvedItems","modal-review-matchPayments","modal-review-confirmObligations","modal-review-reviewSignals","modal-review-closeMonth"];if(!e.length||e.some(r=>!r.checked)||t.some(r=>!Si(r))){ye("Confirm every account balance and complete each operating check before finishing the review.");return}const n=e.map((r,o)=>({accountId:r.dataset.accountId||"",rawBalance:T(`modal-review-balance-${o}`)}));if(n.some(r=>!r.rawBalance||!Number.isFinite(Number(r.rawBalance)))){ye("Add a valid balance for every reconciled account.");return}try{te.completeWeeklyReview({accounts:n.map(r=>({accountId:r.accountId,balance:Number(r.rawBalance)})),unresolvedItems:!0,matchPayments:!0,confirmObligations:!0,reviewSignals:!0,closeMonth:!0,notes:T("modal-review-notes")}),bt()}catch(r){ye(r instanceof Error?r.message:"Could not complete this review.")}},deleteGoal:e=>{e&&vt({action:"deleteGoal",targetId:e,title:"Delete savings goal",copy:"This deletes the selected savings or buffer goal. It does not delete linked account balances.",phrase:"DELETE SAVINGS GOAL",buttonLabel:"Delete goal",reopenModal:"goals"})},exportFinanceBackup:()=>hl(),exportTransactionsCsv:()=>bl(),chooseFinanceBackup:()=>document.querySelector("#modal-backup-file")?.click(),undoImportBatch:e=>{e&&vt({action:"undoImportBatch",targetId:e,title:"Undo CSV import",copy:"This reverses the transactions imported in the selected CSV batch.",phrase:"UNDO CSV IMPORT",buttonLabel:"Undo import",renderAfter:!0})},chooseCsvImport:()=>document.querySelector("#modal-csv-file")?.click(),analyzeCsvImport:()=>{try{ha(),Qe=Ma(qn),Ft=Fr(Qe.headers),kn="",Pr(),Ke=null,gn="",ht("csvImport")}catch(e){Qe=null,Ke=null,kn="",gn=e instanceof Error?e.message:"Could not parse this CSV.",ht("csvImport")}},previewCsvImport:()=>{try{ha(),Qe||(Qe=Ma(qn));const e=te.getActiveFinanceEvents().map(t=>String(t.metadata?.fingerprint||"")).filter(Boolean);Ke=Dc(Qe,Ft,{existingFingerprints:e,defaultCategory:Hn,defaultScope:Wn,sourceFile:Ii}),dr(),gn="",ht("csvImport")}catch(e){Ke=null,gn=e instanceof Error?e.message:"Could not preview this CSV.",ht("csvImport")}},importCsvData:()=>{if(ha(),!Vn){ye("Choose a destination account before importing.");return}if(!Ke){ye("Preview at least one valid row before importing.");return}try{const e=Ai==="import"?[...Ke.rows,...Ke.duplicates]:Ke.rows;if(!e.length){ye("Preview at least one valid row before importing.");return}const t=te.importCsvTransactions(e,{accountId:Vn,sourceFile:Ke.sourceFile,duplicatePolicy:Ai,duplicateCount:Ke.duplicates.length,rejectedCount:Ke.rejected.length});dr(),gn=`Imported ${t.imported} row${t.imported===1?"":"s"}${t.duplicateImported?` · included ${t.duplicateImported} duplicate${t.duplicateImported===1?"":"s"}`:""}${t.duplicates?` · skipped ${t.duplicates} duplicate${t.duplicates===1?"":"s"}`:""}.`,Ke=null,ht("csvImport")}catch(e){ye(e instanceof Error?e.message:"Could not import this CSV.")}},applyBackupRestore:()=>{if(!ci?.valid||!Ln){ye("Choose a valid Finance Master backup before restoring.");return}vt({action:"restoreBackup",title:"Replace local finance data",copy:"This replaces the current local Finance Master data in this browser with the selected backup.",phrase:"RESTORE LOCAL FINANCE DATA",buttonLabel:"Replace current data"})},applyDestructiveConfirmation:()=>{const e=li;if(!e){ye("Choose an action before confirming.");return}if(T("modal-destructive-phrase")!==e.phrase){ye("The confirmation phrase does not match.");return}try{if(e.action==="restoreBackup"){if(!ci?.valid||!Ln)throw new Error("Choose a valid Finance Master backup before restoring.");te.restoreBackup(Ln),Ln=null,ci=null}else if(e.action==="resetLocalFinanceData")te.resetLocalFinanceData();else if(e.action==="resetDemoData")te.clearAndReseedDemo();else if(e.action==="deleteDemoData")te.deleteSampleData();else if(e.action==="archiveProjectProfile"){if(!e.targetId)throw new Error("Choose a project plan before archiving.");te.archiveProjectProfile(e.targetId)}else if(e.action==="deactivateFiatAccount"||e.action==="deactivateReserveBucket"||e.action==="deactivateRecurringExpense"||e.action==="deactivateDebtAccount"){if(!e.targetId)throw new Error("Choose an item before deactivating.");te[e.action](e.targetId)}else if(e.action==="deleteDebtAccount"){if(!e.targetId)throw new Error("Choose a debt item before deleting.");te.deleteDebtAccount(e.targetId)}else if(e.action==="completeDebtPlan"){if(!e.targetId)throw new Error("Choose a debt item before completing.");te.setDebtPlanStatus(e.targetId,"completed")}else if(e.action==="archiveDebtPlan"){if(!e.targetId)throw new Error("Choose a debt item before archiving.");te.setDebtPlanStatus(e.targetId,"archived")}else if(e.action==="reverseTransaction"){if(!e.targetId)throw new Error("Choose a transaction before reversing.");te.reverseTransaction(e.targetId,e.source||"modal.transaction.reverse")}else if(e.action==="deleteInvoice"){if(!e.targetId)throw new Error("Choose an income entry before archiving.");te.deleteInvoice(e.targetId,{reverseSettlement:e.reverseSettlement===!0})}else if(e.action==="cancelPipelineItem"){if(!e.targetId)throw new Error("Choose a pipeline item before cancelling.");te.cancelPipelineItem(e.targetId,e.source||"Cancelled.")}else if(e.action==="deleteGoal"){if(!e.targetId)throw new Error("Choose a goal before deleting.");te.deleteGoal(e.targetId)}else if(e.action==="undoImportBatch"){if(!e.targetId)throw new Error("Choose an import batch before undoing.");te.undoImportBatch(e.targetId)}const t=e.reopenModal,n=e.renderAfter===!0;_a(te),bt(),t&&ht(t),(n||!t)&&window.FinancialMode?.render?.()}catch(t){ye(t instanceof Error?t.message:"Could not complete this action.")}}});document.addEventListener("click",e=>{const t=e.target?.closest("[data-action]"),n=e.target;if(!t){n&&Cn?.classList.contains("active")&&!Cn.contains(n)&&!Da?.contains(n)&&Mi();return}const r=t.dataset.action;r&&(r!=="toggleQuickActionMenu"&&Cn?.contains(t)&&Mi(),e.preventDefault(),Sl(r)?.(...wl(t.dataset.actionArgs||"")))});Tt?.addEventListener("click",e=>{e.target===Tt&&bt()});document.addEventListener("keydown",e=>{if(e.key==="Escape"&&Cn?.classList.contains("active")){Mi();return}if(!Tt?.classList.contains("active"))return;if(e.key==="Escape"){bt();return}if(e.key!=="Tab")return;const t=[...Tt.querySelectorAll('button:not([disabled]), input:not([type="hidden"]):not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(o=>o.offsetParent!==null);if(!t.length)return;const n=t[0],r=t[t.length-1];Tt.contains(document.activeElement)?e.shiftKey&&document.activeElement===n?(e.preventDefault(),r.focus()):!e.shiftKey&&document.activeElement===r&&(e.preventDefault(),n.focus()):(e.preventDefault(),(e.shiftKey?r:n).focus())});document.addEventListener("input",e=>{e.target?.id==="modal-destructive-phrase"&&Oc()});document.addEventListener("change",e=>{const t=e.target;if(!t?.files?.[0])return;const n=new FileReader;if(t.id==="modal-csv-file"){n.onload=()=>{try{qn=String(n.result||""),Ii=t.files?.[0]?.name||"imported-transactions.csv",Qe=Ma(qn),Ft=Fr(Qe.headers),kn="",Pr(),Ke=null,gn="",ht("csvImport")}catch(r){Qe=null,Ke=null,kn="",gn=r instanceof Error?r.message:"Could not parse this CSV file.",ht("csvImport")}},n.readAsText(t.files[0]);return}t.id==="modal-backup-file"&&(n.onload=()=>{try{Ln=JSON.parse(String(n.result||"")),ci=te.previewBackup(Ln)}catch(r){Ln=null,ci={valid:!1,counts:{},errors:[r instanceof Error?r.message:"Could not read this backup."]}}ht("backupRestore")},n.readAsText(t.files[0]))});function $l(e,t){const n={decisions:{title:"Decision Lab",copy:"Test spending, payment, income, and project decisions before acting.",sections:["decisionBoard"]},flow:{title:"Cash Timeline",copy:"Upcoming income, obligations, payment plans, low points, and runway over time.",sections:["cashCalendar","scenarioOutcomes","projection","invoices"]},plan:{title:"Money Plan",copy:"Accounts, reserves, recurring costs, debts, payment plans, and project cash.",sections:["reserves"]},radar:{title:"Risk Radar",copy:"Early warnings, weak assumptions, concentration risks, and opportunities.",sections:["reports"]},review:{title:"Reality Check",copy:"A lightweight loop to confirm the numbers still reflect reality.",sections:["reviewQueue","obligationReview","paymentReview","tensionSignals","weeklyReview"]},logbook:{title:"Records",copy:"Imports, transactions, matching evidence, cleanup, and detailed records.",sections:["ledger"]},settings:{title:"Settings",copy:"App behavior, local data and privacy, backup/restore, defaults, and display preferences.",sections:["data","settings"]}};return function(o){const c=n[o];return c?[t(c.title,c.copy),...c.sections.map(u=>e[u]())]:['<div class="fin-dashboard-main">',t("Money Status","Your current financial condition, safe-to-spend, runway, and next move."),e.observatoryHeader(),e.dashboardCockpit(),e.nextActions(),e.todaysDecision(),e.next30Days(),e.strategicPicture(),"</div>"]}}function v(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function $e(e){return String(e??"").replace(/\\/g,"\\\\").replace(/'/g,"\\'")}function Xt(e,t,n){const r=Number(e)||0;return`${r} ${r===1?t:n||`${t}s`}`}function ur(e){return[["all","All scopes"],["business","Business"],["personal","Personal"],["shared","Shared"]].map(([t,n])=>`<option value="${t}"${e===t?" selected":""}>${n}</option>`).join("")}function ke(e){const t=Date.parse(String(e||""));return Number.isFinite(t)?new Date(t).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}):"Not yet"}function Me(e){return`<div class="fin-compact-empty">${v(e)}</div>`}function jr(e){const t=String(e||"").replace(/_/g," ");return t?t.charAt(0).toUpperCase()+t.slice(1):"Review"}function kt(e){const t=String(e||"needs_review").toLowerCase();return`<span class="fin-status-pill fin-status-pill--${v(t)}">${v(jr(t))}</span>`}function pe({label:e,action:t="",args:n="",local:r=!1,variant:o="secondary",size:c="md",iconHtml:u="",extraClass:m="",attrs:f="",fullWidth:y=!1}={}){const h=t?r?`data-fin-action="${v(t)}"`:`data-action="${v(t)}"${n?` data-action-args="${v(n)}"`:""}`:"",b=["fin-button",`fin-button--${String(o||"secondary")}`,`fin-button--${String(c||"md")}`,y?"fin-button--full":"",m].filter(Boolean).join(" ");return`
        <button class="${v(b)}" type="button" ${h} ${f}>
            ${u||""}
            <span>${v(e||"Action")}</span>
        </button>
    `}function un(e,t){const n=t||e||"widget";return`
    ...
    `}function wi({eyebrow:e="",title:t="",subtitle:n="",actions:r=""}={}){return`
    ...
    `}function ni(e="",{align:t="end"}={}){return e?`<div class="fin-widget-footer fin-widget-footer--${v(t)}">${e}</div>`:""}function zt({title:e="",meta:t="",metaHtml:n="",amount:r="",amountClass:o="",rightHtml:c="",actionHtml:u="",iconHtml:m="",extraClass:f="",attrs:y=""}={}){return`
    ...
    `}function Il({title:e="",sections:t=[],formulaHtml:n="",extraHtml:r=""}={}){return`
    ...
    `}function An(e){return Array.isArray(e)?e:[]}function ja(e){const t=Number(e);return Number.isFinite(t)?Math.round(t*100)/100:0}function Et(e){if(typeof e=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(e))return e;const t=new Date(e||"");return Number.isFinite(t.getTime())?t.toISOString().slice(0,10):""}function Ml(e,t){const n=new Date(e.getTime());return n.setUTCDate(n.getUTCDate()+t),n}function Nl(e,t){const n=Et(t);if(!n)return null;const r=new Date(`${n}T12:00:00.000Z`),o=new Date(`${Et(e)}T12:00:00.000Z`);return!Number.isFinite(r.getTime())||!Number.isFinite(o.getTime())?null:Math.floor((r.getTime()-o.getTime())/864e5)}function ii(e,t,n){const r=Nl(n,t.date);if(r==null||r<0||r>90)return;const o={...t,date:Et(t.date),daysUntil:r,amount:ja(t.amount)};r<=7&&e["7d"].push(o),r<=30&&e["30d"].push(o),e["90d"].push(o)}function Br(e,t){const n=new Date(`${Et(t)}T12:00:00.000Z`),r=Math.max(1,Math.min(28,Number(e&&e.dueDay)||n.getUTCDate()));for(let o=0;o<4;o+=1){const c=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth()+o,r,12));if(c>=n)return Et(c)}return Et(n)}function Dl(e,t){return String(e&&e.planStatus||"")==="starts_later"&&e.startDate?Et(e.startDate):e.dueDate?Et(e.dueDate):Br({dueDay:1},t)}function Cl(e){const t=Number(e&&e.monthlyPressure);if(Number.isFinite(t)&&t>0)return t;const n=Number(e&&(e.paymentAmount??e.minimumPayment));return Number.isFinite(n)?Math.max(0,n):0}function xl(e){return Et(e&&(e.expectedDateISO||e.expectedDate||e.dueDate))}function kl(e){const t=Number(e&&(e.value??e.amount)),n=Number(e&&e.probability),r=Number.isFinite(n)?Math.max(0,Math.min(1,n)):1;return ja((Number.isFinite(t)?t:0)*r)}function ba(e){const t=new Set;return An(e).filter(n=>{const r=`${n.sourceType||""}:${n.sourceId||n.id||""}:${n.date||""}:${n.amount||0}`;return t.has(r)?!1:(t.add(r),!0)}).sort((n,r)=>n.date!==r.date?String(n.date).localeCompare(String(r.date)):Math.abs(Number(r.amount)||0)-Math.abs(Number(n.amount)||0))}function Lr({readModel:e={},treasury:t={},decisionEngine:n=null,nowIso:r=new Date().toISOString()}={}){const o=Et(r)||Et(new Date),c={"7d":[],"30d":[],"90d":[]};An(e.recurringExpenses).forEach(m=>{m&&m.active===!1||ii(c,{id:String(m.id||`expense-${m.category||""}`),sourceId:String(m.id||""),sourceType:"recurring_cost",kind:"Recurring cost",label:String(m.category||"Recurring cost"),date:Br(m,o),amount:-Math.abs(Number(m.monthlyAmount)||0),route:"plan"},o)}),An(e.debtAccounts).forEach(m=>{if(!m||m.active===!1)return;const f=String(m.planStatus||"");if(f==="archived"||f==="completed")return;const y=Cl(m);if(f==="missing"&&y<=0){ii(c,{id:String(m.id||`debt-${m.name||""}`),sourceId:String(m.id||""),sourceType:"debt_plan",kind:"Debt plan review",label:String(m.name||"Debt plan"),date:o,amount:0,route:"plan"},o);return}y<=0&&f!=="starts_later"||ii(c,{id:String(m.id||`debt-${m.name||""}`),sourceId:String(m.id||""),sourceType:"debt_plan",kind:f==="starts_later"?"Debt starts":"Debt plan",label:String(m.name||"Debt plan"),date:Dl(m,o),amount:-Math.abs(y),route:"plan"},o)}),An(e.pipelineDeals).forEach(m=>{const f=String(m&&m.status||"").toLowerCase();if(["paid","cancelled","lost"].includes(f))return;const y=xl(m);if(!y)return;const h=kl(m);h<=0||ii(c,{id:String(m.id||`income-${m.title||""}`),sourceId:String(m.id||""),sourceType:"income",kind:"Expected income",label:String(m.title||m.client||"Expected income"),date:y,amount:h,route:"flow"},o)}),An(t.obligations).forEach(m=>{if(String(m&&m.status||"").toLowerCase()==="paid")return;const y=Et(m&&m.dueDate);if(!y)return;const h=String(m&&m.type||"").toLowerCase();ii(c,{id:String(m.id||`obligation-${m.title||""}`),sourceId:String(m.sourceId||m.id||""),sourceType:h==="recurring_cost"?"recurring_cost":h==="debt"?"debt_plan":"obligation",kind:h==="recurring_cost"?"Recurring cost":h==="debt"?"Debt plan":"Obligation",label:String(m.title||"Obligation"),date:y,amount:-Math.abs(Number(m.amount)||0),route:"review"},o)}),An(e.reserveBuckets).forEach(m=>{if(!m||m.active===!1)return;const f=Number(m.targetAmount)||0,y=Number(m.currentAmount)||0,h=Math.max(0,f-y);h<=0||ii(c,{id:String(m.id||`reserve-${m.name||""}`),sourceId:String(m.id||""),sourceType:"reserve",kind:"Reserve gap",label:String(m.name||"Reserve bucket"),date:Et(Ml(new Date(`${o}T12:00:00.000Z`),30)),amount:-ja(h),route:"plan"},o)});const u=new Map(An(n&&n.weeklyFocus).map(m=>[String(m.sourceCardId||""),m]));return An(n&&n.decisionCards).forEach(m=>{const f=u.get(String(m.id||""));f&&Object.keys(c).forEach(y=>{c[y].forEach(h=>{!h.focusId&&String(h.sourceId||"")&&String(m.relatedId||"")===String(h.sourceId)&&(h.focusId=f.id,h.focusLabel=f.title)})})}),c["7d"]=ba(c["7d"]),c["30d"]=ba(c["30d"]),c["90d"]=ba(c["90d"]),c}function Nn(e){return Array.isArray(e)?e:[]}function Se(e){return Math.round((Number(e)||0)*100)/100}function Mn(e){const t=String(e||"");if(/^\d{4}-\d{2}-\d{2}/.test(t))return t.slice(0,10);const n=Date.parse(t);return Number.isFinite(n)?new Date(n).toISOString().slice(0,10):""}function ji(e,t){const n=Date.parse(`${Mn(e)}T00:00:00.000Z`),r=Date.parse(`${Mn(t)}T00:00:00.000Z`);return!Number.isFinite(n)||!Number.isFinite(r)?null:Math.floor((n-r)/(1440*60*1e3))}function Fl(e){const t=String(e||"monthly").toLowerCase().replace(/\s+/g,"_").replace(/-/g,"_");return t==="annual"||t==="annually"?"yearly":t==="every_two_weeks"||t==="two_weekly"||t==="fortnightly"?"biweekly":["weekly","biweekly","monthly","quarterly","yearly"].includes(t)?t:"monthly"}function Tl(e,t){const n=Math.max(0,Number(e)||0),r=Fl(t);return Se(r==="weekly"?n*52/12:r==="biweekly"?n*26/12:r==="quarterly"?n/3:r==="yearly"?n/12:n)}function El(e){const t=Number(e&&e.customMonthlyPressure);if(Number.isFinite(t)&&t>0)return Se(t);const n=Number(e&&(e.monthlyPressure||e.minimumPaymentMonthly));return Number.isFinite(n)&&n>0?Se(n):Tl(e&&(e.paymentAmount??e.minimumPayment),e&&(e.paymentFrequency||e.frequency))}function Ur(e){const t=String(e&&(e.status||e.stage)||"").toLowerCase();return!["paid","received","settled","cancelled","lost","deleted"].includes(t)}function Pl(e){const t=Number(e&&e.probability);if(Number.isFinite(t))return Math.max(0,Math.min(1,t));const n=String(e&&(e.status||e.stage)||"expected").toLowerCase();return["confirmed","invoiced","due","overdue"].includes(n)?.9:n==="proposal"?.4:n==="lead"?.15:.6}function Rl(e){return e==="Plan"||e==="Money Plan"?"plan":e==="Flow"||e==="Cash Timeline"?"flow":e==="Radar"||e==="Risk Radar"?"radar":e==="Review"||e==="Reality Check"?"review":"decisions"}function qt(e){const t=e.severity||"info",n=e.source||"Decision Lab";return{id:e.id,title:e.title,status:e.status||t,urgency:e.urgency||t,severity:t,affectedMetric:e.affectedMetric||"",explanation:e.explanation||e.why||"",sourceData:e.sourceData||"",suggestedAction:e.suggestedAction||"Review this decision.",actionLabel:e.actionLabel||"Review",actionRoute:e.actionRoute||Rl(n),optionalScenario:!!e.optionalScenario,metricImpact:e.metricImpact||"",sourceIds:Nn(e.sourceIds).map(String),trigger:e.trigger||e.id,why:e.why||e.explanation||"",source:n}}function Bi(e){return{critical:5,high:4,warning:3,medium:2,info:1,opportunity:0}[String(e||"").toLowerCase()]||0}function Li(e,t,n){if(n==null||n<0)return;const r={id:t.id,label:t.label,date:t.date,amount:Se(t.amount||0),kind:t.kind,sourceId:t.sourceId||t.id};n<=7&&e["7d"].push(r),n<=30&&e["30d"].push(r),n<=90&&e["90d"].push(r)}function Ol(e){return Nn(e&&e.pipelineDeals).some(t=>{const n=String(t&&t.scope||"business").toLowerCase();return Ur(t)&&(n==="business"||n==="shared")})||Nn(e&&e.transactions).some(t=>{const n=String(t&&t.scope||"").toLowerCase();return String(t&&t.type)==="income.received"&&(n==="business"||n==="shared")})}function _l(e){const t=Nn(e&&e.reserveBuckets).filter(o=>{const c=`${o&&o.name||""} ${o&&o.purpose||""} ${o&&o.bucket||""}`.toLowerCase();return o&&o.active!==!1&&(c.includes("tax")||c.includes("vat"))}),n=t.reduce((o,c)=>o+Math.max(0,Number(c.currentAmount??c.amount)||0),0),r=t.reduce((o,c)=>o+Math.max(0,Number(c.targetAmount)||0),0);return{buckets:t,current:Se(n),target:Se(r),gap:Se(Math.max(0,r-n))}}function jl(e){return{id:`focus-${e.id}`,title:e.suggestedAction,reason:e.why||e.explanation,urgency:e.urgency,sourceCardId:e.id,actionLabel:e.actionLabel,actionRoute:e.actionRoute}}function mr({readModel:e={},snapshot:t={},treasury:n={},forecast:r={},roadmapMetrics:o={},reviewState:c={},settings:u={},nowIso:m=new Date().toISOString()}={}){const f=Mn(m)||new Date().toISOString().slice(0,10),y=Number((n&&n.actualCash)??(t&&t.realBalance)??0),h=Number((n&&n.availableCash)??(t&&t.availableCash)??y),b=Number((n&&n.safeToSpend)??(t&&t.safeToSpend)??h),_=Math.max(0,Number((n&&n.totalMonthlyBurn)??(t&&t.monthlyBurn)??0)||0),B=Number((n&&n.runwayMonths)??(t&&t.runwayMonths)),N=Math.max(0,Number((n&&n.confirmedShortTermObligations)??(n&&n.committedShortTermObligations)??0)||0);Math.max(0,Number(n&&n.minimumBuffer)||0);const x=Math.max(0,Number(r&&r.byHorizon&&r.byHorizon[30]&&r.byHorizon[30].components&&r.byHorizon[30].components.expectedIncome)||0),q=[],H=[],fe=[],J={"7d":[],"30d":[],"90d":[]},K=String(u&&u.riskTolerance||"balanced"),W=O=>{q.push(O),H.push(O)},re=O=>{q.push(O),fe.push(O)};(b<0||h<0)&&W(qt({id:"negative-safe-cash",title:"Near-term cash is overcommitted",severity:"critical",affectedMetric:"Safe-to-Spend",explanation:"Available cash or Safe-to-Spend is below zero after protected cash and confirmed pressure.",why:"The current cash position cannot cover the visible near-term commitments.",sourceData:`Safe-to-Spend ${Se(b)} · Available cash ${Se(h)}`,suggestedAction:"Protect liquidity before optional spending.",actionLabel:"Open Money Plan",actionRoute:"plan",metricImpact:`${Se(Math.min(b,h))}`,trigger:"negative-safe-to-spend-or-available-cash",source:"Money Plan"})),Number.isFinite(B)&&B<1&&W(qt({id:"low-runway-critical",title:"Runway is below one month",severity:"critical",affectedMetric:"Runway",explanation:"Available cash covers less than one month at the current monthly burn.",why:"Runway below one month leaves little room for delayed income or surprise obligations.",sourceData:`${Se(B)} months`,suggestedAction:"Reduce burn or collect confirmed revenue this week.",actionLabel:"Open Cash Timeline",actionRoute:"flow",metricImpact:`${Se(B)} months`,trigger:"runway-under-one-month",source:"Cash Timeline"})),b>0&&Number.isFinite(B)&&B<2&&W(qt({id:"safe-spend-runway-mismatch",title:"Safe-to-Spend is positive but runway is weak",severity:"warning",affectedMetric:"Runway",explanation:"The short-term spending number is positive, but the medium-term runway is still thin.",why:"Available cash may cover the next 30 days while recurring pressure still drains the next months.",sourceData:`Safe-to-Spend ${Se(b)} · runway ${Se(B)} months`,suggestedAction:"Favor cash-preserving choices until runway is above two months.",actionLabel:"Open Cash Timeline",actionRoute:"flow",metricImpact:`${Se(B)} months`,trigger:"safe-to-spend-positive-runway-under-two",source:"Cash Timeline"})),N>Math.max(0,b)&&W(qt({id:"overloaded-month",title:"The next 30 days are overloaded",severity:"high",affectedMetric:"30-day obligations",explanation:"Confirmed obligations due soon exceed the current Safe-to-Spend amount.",why:"The month needs a liquidity decision before new optional spending.",sourceData:`${Se(N)} due · ${Se(b)} safe`,suggestedAction:"Delay optional spending or pull confirmed income forward.",actionLabel:"Open Reality Check",actionRoute:"review",metricImpact:`${Se(N-Math.max(0,b))} gap`,trigger:"thirty-day-obligations-exceed-safe-cash",source:"Reality Check"})),Nn(e&&e.obligations).forEach(O=>{const U=Mn(O&&O.dueDate),V=ji(U,f);Li(J,{id:`obligation-${O&&O.id}`,label:String(O&&O.title||"Obligation"),date:U,amount:Number(O&&O.amount)||0,kind:"Obligation",sourceId:O&&O.id},V)}),Nn(e&&e.recurringExpenses).forEach(O=>{const U=Math.max(1,Math.min(28,Number(O&&O.dueDay)||1)),V=new Date(`${f}T12:00:00.000Z`),R=new Date(Date.UTC(V.getUTCFullYear(),V.getUTCMonth(),U,12));Mn(R)<f&&R.setUTCMonth(R.getUTCMonth()+1);const Y=Mn(R);Li(J,{id:`recurring-${O&&O.id}`,label:String(O&&O.category||"Recurring cost"),date:Y,amount:Number(O&&O.monthlyAmount)||Number(O&&O.amount)||0,kind:"Recurring cost",sourceId:O&&O.id},ji(Y,f))}),Nn(e&&e.debtAccounts).forEach(O=>{const U=Number(O&&O.outstanding)||0;if(U<=0)return;const V=String(O&&O.planStatus||"missing"),R=El(O),Y=Mn(O&&O.startDate),oe=ji(Y,f);V==="starts_later"&&Y&&(Li(J,{id:`debt-start-${O&&O.id}`,label:`${O&&O.name||"Debt plan"} starts`,date:Y,amount:R,kind:"Debt starts",sourceId:O&&O.id},oe),oe!=null&&oe>=0&&oe<=30&&W(qt({id:`debt-starts-${O&&O.id}`,title:"Payment pressure starts soon",severity:"warning",affectedMetric:"Monthly burn",explanation:`${O&&O.name||"A debt plan"} starts within 30 days and will add visible payment pressure.`,why:"A future-starting debt plan is not current burn yet, but it is close enough to plan around.",sourceData:`${Y} · ${Se(R)} / month`,suggestedAction:"Review the payment plan before it becomes active.",actionLabel:"Open debt plan",actionRoute:"plan",metricImpact:`+${Se(R)} monthly pressure`,sourceIds:[O&&O.id],trigger:"debt-starts-within-thirty-days",source:"Money Plan",optionalScenario:!0}))),V==="on_hold"&&W(qt({id:`debt-on-hold-${O&&O.id}`,title:"Paused debt is hidden pressure",severity:"info",affectedMetric:"Debt pressure",explanation:`${O&&O.name||"A debt"} is on hold, so it is excluded from monthly burn today.`,why:"Paused debt is still a liability and should be reviewed before it quietly returns.",sourceData:`${Se(U)} outstanding · ${Se(R)} potential monthly pressure`,suggestedAction:"Set a review date or confirm the hold.",actionLabel:"Open debt planner",actionRoute:"plan",metricImpact:`${Se(R)} hidden monthly pressure`,sourceIds:[O&&O.id],trigger:"paused-debt-hidden-pressure",source:"Money Plan"})),V==="irregular"&&R<=0&&W(qt({id:`debt-irregular-${O&&O.id}`,title:"Irregular debt pressure needs a monthly estimate",severity:"info",affectedMetric:"Debt pressure",explanation:`${O&&O.name||"A debt"} is irregular without custom monthly pressure.`,why:"The liability is visible, but its monthly pressure cannot influence decisions until estimated.",sourceData:`${Se(U)} outstanding`,suggestedAction:"Add a custom monthly pressure estimate.",actionLabel:"Open debt planner",actionRoute:"plan",metricImpact:"Hidden pressure",sourceIds:[O&&O.id],trigger:"irregular-debt-without-pressure",source:"Money Plan"})),V==="missing"&&W(qt({id:`debt-missing-plan-${O&&O.id}`,title:"Debt exists without a payment plan",severity:"warning",affectedMetric:"Monthly burn",explanation:`${O&&O.name||"A debt"} has outstanding balance without normalized payment behavior.`,why:"Long-term pressure is hidden until the debt has a payment plan.",sourceData:`${Se(U)} outstanding`,suggestedAction:"Add a payment plan so burn and runway stay accurate.",actionLabel:"Add payment plan",actionRoute:"plan",metricImpact:"Unknown monthly pressure",sourceIds:[O&&O.id],trigger:"missing-debt-payment-plan",source:"Money Plan"}))});const le=_l(e);Ol(e)&&(!le.buckets.length||le.gap>0||le.target>0&&le.current/le.target<.5)&&W(qt({id:"tax-reserve-underfunded",title:"Tax reserve may be underfunded",severity:le.buckets.length?"warning":"info",affectedMetric:"Protected cash",explanation:le.buckets.length?"A tax or VAT reserve exists but is below target.":"Business income is visible but no tax or VAT reserve target is active.",why:"Unreserved tax money can make cash look safer than it is.",sourceData:`${Se(le.current)} protected · ${Se(le.target)} target`,suggestedAction:"Allocate part of incoming business revenue to tax/VAT reserve.",actionLabel:"Open Money Plan",actionRoute:"plan",metricImpact:`${Se(le.gap)} reserve gap`,trigger:"business-income-with-tax-reserve-gap",source:"Money Plan"})),y>0&&_>0&&x>0&&_>x&&W(qt({id:"positive-cash-negative-structure",title:"Cash looks healthy but structure is weak",severity:"warning",affectedMetric:"Monthly burn",explanation:"Total cash is positive, but monthly burn is higher than expected 30-day income.",why:"The current balance may hide a weak operating structure.",sourceData:`${Se(_)} burn · ${Se(x)} expected income`,suggestedAction:"Review recurring burn and near-term revenue coverage.",actionLabel:"Open Risk Radar",actionRoute:"radar",metricImpact:`${Se(_-x)} monthly structure gap`,trigger:"positive-cash-high-burn-relative-revenue",source:"Risk Radar"})),Nn(e&&e.pipelineDeals).filter(Ur).forEach(O=>{const U=Math.max(0,Number(O&&(O.value??O.amount))||0);if(U<=0)return;const V=Pl(O),R=Se(U*V),Y=_>0?Se(R/_):null,oe=Mn(O&&O.expectedDateISO),de=ji(oe,f);oe&&Li(J,{id:`income-${O&&O.id}`,label:String(O&&(O.title||O.client||O.name)||"Expected income"),date:oe,amount:R,kind:"Expected income",sourceId:O&&O.id},de);const xe=b<0||Number.isFinite(B)&&B<3||N>Math.max(0,b);Y!=null&&(Y>=.5||xe)&&re(qt({id:`opportunity-${O&&O.id}`,title:`${O&&(O.title||O.client||O.name)||"Opportunity"} could extend runway`,severity:"opportunity",affectedMetric:"Runway",explanation:`Expected value could add about ${Y.toFixed(1)} months of runway at current burn.`,why:xe?"This opportunity helps the current pressure point.":"The opportunity meaningfully improves the runway picture.",sourceData:`${Se(R)} expected value · ${Math.round(V*100)}% confidence`,suggestedAction:"Follow up while it can still affect the forecast.",actionLabel:"Open Cash Timeline",actionRoute:"flow",metricImpact:`+${Y.toFixed(1)} months runway`,sourceIds:[O&&O.id],trigger:"opportunity-runway-impact",source:"Cash Timeline",optionalScenario:!0}))});const Ne=Date.parse(String(c&&c.lastReviewedAt||""));Number.isFinite(Ne)||W(qt({id:"weekly-review-due",title:"Weekly money check is due",severity:"info",affectedMetric:"Data quality",explanation:"No recent checkpoint is saved for the current operating picture.",why:"Manual finance data stays trustworthy when cash accounts and assumptions are reviewed.",sourceData:"No saved checkpoint",suggestedAction:"Run the weekly review and choose this week’s focus.",actionLabel:"Open Reality Check",actionRoute:"review",metricImpact:"Improves confidence",trigger:"weekly-review-not-current",source:"Reality Check"})),q.sort((O,U)=>Bi(U.severity)-Bi(O.severity));const Ae=q.filter(O=>O.severity!=="opportunity").slice(0,3).map(jl);let C={key:"stable",label:"Stable",severity:"info",explanation:"No major decision pressure is visible in the current local data.",primaryMetric:Number.isFinite(B)?`${Se(B)} months runway`:`${Se(b)} Safe-to-Spend`,riskTolerance:K};const F=q[0];F&&(F.id==="negative-safe-cash"?C={key:"critical",label:"Critical",severity:"critical",explanation:F.why,primaryMetric:F.sourceData,riskTolerance:K}:F.id==="low-runway-critical"?C={key:"critical-runway",label:"Critical",severity:"critical",explanation:F.why,primaryMetric:F.sourceData,riskTolerance:K}:F.id==="safe-spend-runway-mismatch"?C={key:"fragile",label:"Fragile",severity:"warning",explanation:F.why,primaryMetric:F.sourceData,riskTolerance:K}:F.id==="overloaded-month"?C={key:"tight",label:"Tight but manageable",severity:"high",explanation:F.why,primaryMetric:F.sourceData,riskTolerance:K}:F.severity==="opportunity"?C={key:"opportunity-window",label:"Opportunity window",severity:"opportunity",explanation:F.why,primaryMetric:F.metricImpact,riskTolerance:K}:C={key:"watchful",label:"Needs attention",severity:F.severity,explanation:F.why,primaryMetric:F.sourceData,riskTolerance:K});const Q=[{id:"late-payment",label:"What if I get paid late?",route:"flow",mode:"display_only"},{id:"pause-debt",label:"What if I pause this debt?",route:"plan",mode:"display_only"},{id:"book-project",label:"What if I book one €3,000 project?",route:"flow",mode:"display_only"},{id:"tax-reserve",label:"What if I reserve 30% for tax?",route:"plan",mode:"display_only"},{id:"reduce-burn",label:"What if I reduce burn by €300/month?",route:"radar",mode:"display_only"}],X=Lr({readModel:e,treasury:n,decisionEngine:{weeklyFocus:Ae,decisionCards:q},nowIso:m});return{generatedAt:m,status:C,weeklyFocus:Ae,decisionCards:q.slice(0,12),warnings:H.sort((O,U)=>Bi(U.severity)-Bi(O.severity)).slice(0,8),opportunities:fe.slice(0,6),pressureTimeline:X||J,scenarioShortcuts:Q}}function zr(e){return Array.isArray(e)?e:[]}function Ce(e){const t=Number(e);return Number.isFinite(t)?Math.round(t*100)/100:0}function en(e,t,n=0){for(const r of t){const o=Number(e&&e[r]);if(Number.isFinite(o))return o}return n}function Bl(e){const t=String(e||"").trim().toLowerCase();return["reduce_flexible_costs","reduce_debt_pressure","add_recurring_income","protect_future_income","pause_savings_goal","increase_reserve_contribution"].includes(t)?t:"reduce_flexible_costs"}function Ca(e,t=0){const n=Bl(e&&e.type),r=Math.max(0,Number(e&&e.amount)||0),o=new Date().toISOString();return{id:String(e&&e.id||`scenario-${n}-${t}`),name:String(e&&e.name||Ll(n)),type:n,amount:r,protectPercent:Math.max(0,Math.min(100,Number(e&&e.protectPercent)||0)),createdAt:String(e&&e.createdAt||o),updatedAt:String(e&&e.updatedAt||o)}}function Ll(e){return{reduce_flexible_costs:"Reduce flexible costs",reduce_debt_pressure:"Reduce debt pressure",add_recurring_income:"Add recurring income",protect_future_income:"Protect future income",pause_savings_goal:"Pause savings goal",increase_reserve_contribution:"Increase reserve contribution"}[e]||"Scenario"}function Ul({snapshot:e={},treasury:t={}}){const n=en(t,["availableCash"],en(e,["availableCash","trulyAvailableCash"],0)),r=en(t,["safeToSpend"],en(e,["safeToSpend"],n)),o=Math.max(0,en(t,["totalMonthlyBurn"],en(e,["monthlyBurn"],0))),c=Math.max(0,en(t,["debtMonthlyPressure","debtPaymentsDueSoon"],en(e,["debtPaymentsDueSoon"],0))),u=Math.max(0,en(t,["protectedCash"],en(e,["reservedCash"],0))),m=Math.max(0,en(t,["reserveGap"],0)),f=o>0?Ce(n/o):null;return{safeToSpend:Ce(r),availableCash:Ce(n),monthlyBurn:Ce(o),runway:f,debtPressure:Ce(c),reserveGap:Ce(m),protectedCash:Ce(u)}}function zl(e,t){const n={...e},r=Math.max(0,Number(t&&t.amount)||0);if(t.type==="reduce_flexible_costs"){const o=Math.min(r,n.monthlyBurn);n.monthlyBurn=Ce(n.monthlyBurn-o),n.safeToSpend=Ce(n.safeToSpend+o)}if(t.type==="reduce_debt_pressure"){const o=Math.min(r,n.debtPressure);n.debtPressure=Ce(n.debtPressure-o),n.monthlyBurn=Ce(Math.max(0,n.monthlyBurn-o)),n.safeToSpend=Ce(n.safeToSpend+o)}if(t.type==="add_recurring_income"&&(n.safeToSpend=Ce(n.safeToSpend+r),n.availableCash=Ce(n.availableCash+r)),t.type==="protect_future_income"){const o=Ce(r*((Number(t.protectPercent)||0)/100));n.safeToSpend=Ce(n.safeToSpend-o),n.availableCash=Ce(n.availableCash-o),n.protectedCash=Ce(n.protectedCash+o),n.reserveGap=Ce(Math.max(0,n.reserveGap-o))}return t.type==="pause_savings_goal"&&(n.safeToSpend=Ce(n.safeToSpend+r),n.availableCash=Ce(n.availableCash+r)),t.type==="increase_reserve_contribution"&&(n.safeToSpend=Ce(n.safeToSpend-r),n.availableCash=Ce(n.availableCash-r),n.protectedCash=Ce(n.protectedCash+r),n.reserveGap=Ce(Math.max(0,n.reserveGap-r))),n.runway=n.monthlyBurn>0?Ce(n.availableCash/n.monthlyBurn):null,n}function ql(e,t){return{safeToSpend:Ce(t.safeToSpend-e.safeToSpend),availableCash:Ce(t.availableCash-e.availableCash),monthlyBurn:Ce(t.monthlyBurn-e.monthlyBurn),runway:e.runway==null||t.runway==null?null:Ce(t.runway-e.runway),debtPressure:Ce(t.debtPressure-e.debtPressure),reserveGap:Ce(t.reserveGap-e.reserveGap)}}function Vl(e){const t=e.runway==null?0:e.runway*100;return Ce(t+e.safeToSpend+Math.abs(Math.min(0,e.monthlyBurn))+Math.abs(Math.min(0,e.debtPressure))+Math.abs(Math.min(0,e.reserveGap)))}function Hl(e,t,n){const r=[];return t.safeToSpend<0&&r.push("This scenario leaves Safe-to-Spend below zero."),t.availableCash<0&&r.push("This scenario leaves available cash below zero."),n.type==="protect_future_income"&&!n.protectPercent&&r.push("Choose a protection percentage to model future-income reserves."),n.type==="increase_reserve_contribution"&&e.reserveGap<=0&&r.push("Reserve gap is already closed in the current model."),r}function Wl(e,t,n){const r=Ca(t,n),o=zl(e,r),c=ql(e,o);return{...r,base:e,adjusted:o,delta:c,impactScore:Vl(c),warnings:Hl(e,o,r)}}function Gl({base:e,forecast:t={},decisionEngine:n={}}){const r=Number(t&&t.byHorizon&&t.byHorizon[30]&&t.byHorizon[30].components&&t.byHorizon[30].components.expectedIncome)||0,o=zr(n&&n.warnings).length?250:150;return[{id:"scenario-flex-cut",type:"reduce_flexible_costs",name:"Reduce flexible costs",amount:Math.min(Math.max(e.monthlyBurn*.08,o),500)},{id:"scenario-debt-pressure",type:"reduce_debt_pressure",name:"Reduce debt pressure",amount:Math.min(Math.max(e.debtPressure*.25,100),e.debtPressure||250)},{id:"scenario-income",type:"add_recurring_income",name:"Add recurring income",amount:Math.max(1e3,Math.min(3e3,r||1500))},{id:"scenario-protect-income",type:"protect_future_income",name:"Protect future income",amount:Math.max(1e3,r||1500),protectPercent:25},{id:"scenario-pause-savings",type:"pause_savings_goal",name:"Pause savings goal",amount:250},{id:"scenario-reserve",type:"increase_reserve_contribution",name:"Increase reserve contribution",amount:Math.min(Math.max(e.reserveGap*.2,100),500)}]}function pr({readModel:e={},snapshot:t={},treasury:n={},forecast:r={},decisionEngine:o={},savedScenarios:c=[],nowIso:u=new Date().toISOString()}={}){const m=Ul({snapshot:t,treasury:n}),f=zr(c).map(Ca),y=Gl({base:m,forecast:r,decisionEngine:o}),h=y.concat(f).map((b,_)=>Wl(m,b,_));return h.sort((b,_)=>_.impactScore-b.impactScore||String(b.name).localeCompare(String(_.name))),{generatedAt:u,base:m,recommended:y.map(Ca),saved:f,comparable:h,topScenario:h[0]||null,warnings:h.flatMap(b=>b.warnings.map(_=>({scenarioId:b.id,warning:_}))).slice(0,6)}}window.FinancialMode=(function(){let e=null,t=null,n=null,r=null,o=null,c={},u=null,m=null,f=null,y=null,h={"7d":[],"30d":[],"90d":[]},b=!1,_=!1,B="",N="",x="",q="";const H={focusMode:"finance-master.layout.focus-mode",pipelineTab:"finance-master.layout.pipeline-tab",ledgerView:"finance-master.layout.ledger-view",ledgerFilters:"finance-master.layout.ledger-filters",selectedTransaction:"finance-master.layout.selected-transaction",invoicesView:"finance-master.layout.invoices-view",treasuryProject:"finance-master.layout.treasury-project",activeSection:"finance-master.layout.active-section"},fe=["dashboard","decisions","flow","plan","radar","review","logbook","settings"],J=[["reduce_flexible_costs","Reduce flexible costs"],["reduce_debt_pressure","Reduce debt pressure"],["add_recurring_income","Add recurring income"],["protect_future_income","Protect future income"],["pause_savings_goal","Pause savings goal"],["increase_reserve_contribution","Increase reserve contribution"]],K={overview:"dashboard",today:"dashboard",pulse:"dashboard",decisions:"decisions",decision:"decisions",cockpit:"decisions",flow:"flow",cashflow:"flow",planning:"flow",income:"flow",invoices:"flow",transactions:"logbook",ledger:"logbook","cash-movement":"logbook",cashmovement:"logbook",cashMovement:"logbook",logbook:"logbook",review:"review","monthly-review":"review",monthlyreview:"review",monthlyReview:"review","month-close":"review",monthclose:"review",monthClose:"review",plan:"plan",map:"plan",treasury:"plan",reserves:"plan",obligations:"plan",fixedcosts:"plan",fixedCosts:"plan",radar:"radar",signals:"radar",reports:"radar",insights:"radar",system:"settings",data:"settings",import:"settings",backup:"settings",settings:"settings"},W={container:document.getElementById("dashboard-financial"),content:document.getElementById("fin-content-area"),switchBtns:document.querySelectorAll(".fin-switch-btn"),mobileNavToggle:document.querySelector('[data-action="FinancialMode.toggleMobileNav"]'),sidebar:document.querySelector(".finance-master-sidebar")};function re(i){return`finance-master.layout.collapsed.${String(i||"").trim()}`}function le(i,a){try{const s=localStorage.getItem(i);if(s==null)return!!a;if(s==="true")return!0;if(s==="false")return!1}catch{}return!!a}function Ne(i,a){try{localStorage.setItem(i,a?"true":"false")}catch{}}function Ae(i){const a=String(i||"dashboard").trim(),s=a.toLowerCase(),g=K[a]||K[s]||a;return fe.indexOf(g)!==-1?g:"dashboard"}function C(){return le(H.focusMode,!1)}function F(i){Ne(H.focusMode,!!i)}function Q(){try{const i=String(localStorage.getItem(H.pipelineTab)||"pipeline").toLowerCase();if(i==="pipeline"||i==="history"||i==="cashflow")return i}catch{}return"pipeline"}function X(i){const a=String(i||"").toLowerCase();if(!(a!=="pipeline"&&a!=="history"&&a!=="cashflow"))try{localStorage.setItem(H.pipelineTab,a)}catch{}}function O(){try{return Ae(localStorage.getItem(H.activeSection)||"dashboard")}catch{return"dashboard"}}function U(i){const a=Ae(i);q="";try{localStorage.setItem(H.activeSection,a)}catch{}He(),ve()}function V(){try{const i=String(localStorage.getItem(H.ledgerView)||"clean").toLowerCase();if(i==="clean"||i==="work"||i==="expected"||i==="matched")return i}catch{}return"clean"}function R(i){const a=String(i||"clean").toLowerCase();if(!(a!=="clean"&&a!=="work"&&a!=="expected"&&a!=="matched"))try{localStorage.setItem(H.ledgerView,a)}catch{}}function Y(){try{const i=String(localStorage.getItem(H.invoicesView)||"open").toLowerCase();if(i==="cashflow")return"rhythm";if(i==="open"||i==="settled"||i==="all"||i==="rhythm")return i}catch{}return"open"}function oe(i){const a=String(i||"open").toLowerCase();if(!(a!=="open"&&a!=="settled"&&a!=="all"&&a!=="rhythm"))try{localStorage.setItem(H.invoicesView,a)}catch{}}function de(){try{return String(localStorage.getItem(H.treasuryProject)||"all").trim()||"all"}catch{return"all"}}function xe(i){const a=String(i||"all").trim()||"all";try{localStorage.setItem(H.treasuryProject,a)}catch{}}function Z(){return{search:"",accountId:"all",scope:"all",categoryId:"",type:"all",reviewStatus:"all",source:"all",importBatchId:"all",linkState:"all",amountMin:"",amountMax:"",dateFrom:"",dateTo:""}}function Pt(){try{const i=JSON.parse(localStorage.getItem(H.ledgerFilters)||"{}");return Object.assign(Z(),i&&typeof i=="object"?i:{})}catch{return Z()}}function Ht(i){try{localStorage.setItem(H.ledgerFilters,JSON.stringify(Object.assign(Z(),i||{})))}catch{}}function _e(){try{localStorage.removeItem(H.ledgerFilters)}catch{}}function et(){try{return String(localStorage.getItem(H.selectedTransaction)||"").trim()}catch{return""}}function st(i){try{i?localStorage.setItem(H.selectedTransaction,String(i)):localStorage.removeItem(H.selectedTransaction)}catch{}}function Rt(i){const a=G(e&&e.fiatAccounts);return[`<option value="all"${i==="all"||!i?" selected":""}>All accounts</option>`,...a.map(s=>`<option value="${v(s.id)}"${String(i)===String(s.id)?" selected":""}>${v(s.name||"Account")}</option>`)].join("")}function rn(i){document.querySelectorAll("[data-fin-nav]").forEach(a=>{const s=String(a.getAttribute("data-fin-nav")||"")===i;a.classList.toggle("active",s),a.setAttribute("aria-current",s?"page":"false")})}function Mt(i){return`
            <button type="button" data-action="${v(i.action)}"${i.args?` data-action-args="${v(i.args)}"`:""}>
                <strong>${v(i.label)}</strong>
                <span>${v(i.copy)}</span>
            </button>
        `}function Ot(i){const a=document.querySelector(".fin-fab-add"),s=document.getElementById("quick-action-menu");if(!a||!s)return;const l=[{key:"transaction",label:"Add transaction",copy:"Record income, expense, or transfer",action:"openEditModal",args:"'transaction', 'expense'"},{key:"income",label:"Add expected income",copy:"Invoice, retainer, or likely payment",action:"openEditModal",args:"'income'"},{key:"cash",label:"Add cash account",copy:"Track a real liquid balance",action:"openEditModal",args:"'fiatAccount'"},{key:"cost",label:"Add recurring cost",copy:"Add pressure to monthly burn",action:"openEditModal",args:"'expense'"},{key:"debt",label:"Add debt item",copy:"Track liability and payment plan",action:"FinancialMode.openAddModal",args:"'debtAdd'"},{key:"reserve",label:"Add reserve bucket",copy:"Protect tax, VAT, health, or buffer cash",action:"openEditModal",args:"'reserveBucket'"},{key:"import",label:"Import CSV",copy:"Bring in local transaction records",action:"openEditModal",args:"'csvImport'"}],g={dashboard:["transaction","income","cash","cost","debt","reserve","import"],decisions:["income","cost","debt","reserve","transaction","cash","import"],flow:["income","cost","transaction","import","cash","debt","reserve"],logbook:["transaction","import","income","cash","cost","debt","reserve"],plan:["cash","cost","debt","reserve","income","transaction","import"],radar:["debt","reserve","income","cost","cash","transaction","import"],review:["transaction","income","cost","debt","reserve","cash","import"],settings:["import","transaction","income","cash","cost","debt","reserve"]},S=g[i]||g.dashboard,$=new Map(S.map((D,z)=>[D,z])),w=l.slice().sort((D,z)=>($.get(D.key)??99)-($.get(z.key)??99));a.classList.toggle("fin-fab-add--hidden",w.length===0),a.setAttribute("aria-hidden",w.length===0?"true":"false"),a.tabIndex=w.length===0?-1:0,w.length||(s.classList.remove("active"),s.setAttribute("aria-hidden","true"),a.setAttribute("aria-expanded","false")),s.innerHTML=w.map(Mt).join("")}function tt(i){const a=!!i,s=typeof window.matchMedia=="function"?window.matchMedia("(max-width: 760px)").matches:!1;document.body.classList.toggle("finance-nav-open",a),W.mobileNavToggle&&(W.mobileNavToggle.setAttribute("aria-expanded",a?"true":"false"),W.mobileNavToggle.setAttribute("aria-label",a?"Close navigation":"Open navigation")),W.sidebar&&(s&&!a?(W.sidebar.setAttribute("aria-hidden","true"),W.sidebar.setAttribute("inert","")):(W.sidebar.removeAttribute("aria-hidden"),W.sidebar.removeAttribute("inert")))}function pn(){tt(!document.body.classList.contains("finance-nav-open"))}function He(){tt(!1)}function Wt(i){return le(re(i),!0)}function Gt(i,a){Ne(re(i),!!a)}function G(i){return Array.isArray(i)?i:[]}function Fe(i,a={}){return typeof window.renderSAGIcon=="function"?window.renderSAGIcon(i,a):""}function j(i,a){if(!b&&(i==null||Number(i)===0)||i==null||!Number.isFinite(Number(i)))return"—";const s=window.Store&&typeof window.Store.getFinanceSettings=="function"?window.Store.getFinanceSettings().baseCurrency:"EUR";if(window.FinanceFormatting&&typeof window.FinanceFormatting.formatCurrencyAmount=="function")return window.FinanceFormatting.formatCurrencyAmount(i,{currency:a,baseCurrency:s});const l=a||s||"EUR";return new Intl.NumberFormat(void 0,{style:"currency",currency:l,minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(i))}function Nt(i,a,s,l){const g=Wt(i);return`
        ...
        `,Ti=(P,ze="ledger")=>{const ft=ue(P),Sn=lt(P),Pn=String(P&&P.reviewStatus||"clear").toLowerCase(),Xn=P.accountName||P.fromAccountName||P.toAccountName||"Account",ei=je(P),Pi=Be(P),aa=String(P&&(P.ledgerType||P.type)||"record").replace(/[._-]/g," "),gt=(()=>{if(P.obligationId||P.linkedObligationTitle||P.obligationTitle)return{label:"Linked to",title:P.linkedObligationTitle||P.obligationTitle||P.obligationId,copy:"Payment matched to monthly obligation.",actionLabel:"Open obligation",action:"openEditModal",args:`'obligationPayment', '${$e(P.obligationId||ft)}'`};if(P.linkedIncomeTitle||P.linkedIncomeId)return{label:"Linked to",title:P.linkedIncomeTitle||P.linkedIncomeId,copy:"Payment matched to expected income.",actionLabel:"Open income",action:"openEditModal",args:`'income', '${$e(P.linkedIncomeId||ft)}'`};if(P.linkedDebtTitle||P.linkedDebtId)return{label:"Linked to",title:P.linkedDebtTitle||P.linkedDebtId,copy:"Payment connected to debt pressure.",actionLabel:"Open debt",action:"openEditModal",args:`'debt', '${$e(P.linkedDebtId)}'`};const Ut=Kt(P);return Ut?{label:"Reserve movement",title:Ut,copy:"This movement affects protected cash.",actionLabel:"Open Money Plan",action:"FinancialMode.setSection",args:"'plan'"}:P.reversalOf||P.reversedBy?{label:"Reversal",title:P.reversalOf?"This reverses another record":"This record was reversed",copy:P.reversalOf?"A correction was recorded for an earlier transaction.":"A later correction reversed this transaction."}:null})(),ra=gt?`${P.description||"This record"} ${gt.copy.charAt(0).toLowerCase()}${gt.copy.slice(1)}`:Pn==="needs_review"?"This record needs your eyes before it can support the forecast.":"This record is part of your local cash movement history.",oa=[Pn==="needs_review"?"Needs review":"Reviewed",gt?"Matched":"",aa,P.scope||"shared"].filter(Boolean),sa=Re(P)?me({action:"openEditModal",args:`'paymentMatch', '${$e(ft)}'`,label:"Edit payment match",icon:"link",tone:"success"}):me({action:"openEditModal",args:`'transactionReview', '${$e(ft)}'`,label:"Edit transaction review"}),ca=Re(P)||gt?"":me({action:"openEditModal",args:`'paymentMatch', '${$e(ft)}'`,label:"Match / link",icon:"link",tone:"muted"});return`
                <div class="${["fin-transaction-row",ze==="review"?"fin-transaction-row--review":"",gt?"fin-transaction-row--linked":"",ft===Lt?"active":""].filter(Boolean).join(" ")}" data-fin-action="select-ledger-transaction" data-fin-transaction-id="${v(ft)}" role="button" tabindex="0" aria-label="Open record detail">
                    <div class="fin-transaction-row-main">
                        <div class="fin-transaction-row-frame">
                            <span>
                                <strong>${v(P.description||"Transaction")}</strong>
                                <small>${v([ke(P.timestamp),Xn].filter(Boolean).join(" · "))}</small>
                            </span>
                            <span class="fin-transaction-row-primary">
                                <strong class="${Sn>=0?"fin-val-pos":"fin-val-neg"}">${Sn>=0?"+":"-"}${j(Math.abs(Sn),P.currency)}</strong>
                                ${ca}
                                ${sa}
                            </span>
                        </div>
                        <div class="fin-chip-row">${oa.map(Ut=>`<span class="fin-status-pill">${v(Ut)}</span>`).join("")}</div>
                        <p class="fin-transaction-human-copy">${v(ra)}</p>
                        ${gt?`
                        ...
                        ${ei.length?`
                            <div class="fin-transaction-suggestion">
                                ...
                                ${ei.map(Ut=>`<strong>${v(Ut.title)}</strong><small>${v(Ut.reason)}</small>`).join("")}
                            </div>
                        `:""}
                        ${Pi.length?`
                            <div class="fin-transaction-suggestion">
                                <span class="fin-eyebrow">Suggested income match</span>
                                ${Pi.map(Ut=>`<strong>${v(Ut.title)}</strong><small>${v(Ut.reason)}</small>`).join("")}
                            </div>
                        `:""}
                    </div>
                </div>
            `},gi=P=>Ti(P,"ledger"),yn=P=>Ti(P,"review"),Ei=yt().slice().sort((P,ze)=>(Date.parse(String(P&&P.expectedDateISO||""))||Number.MAX_SAFE_INTEGER)-(Date.parse(String(ze&&ze.expectedDateISO||""))||Number.MAX_SAFE_INTEGER)),ta=P=>{const ze=pi(P),ft=Number(P&&P.probability),Sn=Number.isFinite(ft)?Math.max(0,Math.min(1,ft)):0,Pn=Number(P&&P.value)||0,Xn=Number(P&&P.vatAmount)||0,ei=Number(P&&P.vatRate)||0;return`
                <div class="fin-transaction-row">
                    <div class="fin-transaction-row-main">
                        <div class="fin-transaction-row-frame">
                            <span>
                                <strong>${v(P&&P.title||"Expected income")}</strong>
                                <small>${v([ke(P&&P.expectedDateISO),ki(P),La({status:ze,dueState:xi(P,ze),incomeType:P&&P.incomeType})].filter(Boolean).join(" · "))}</small>
                                ${Xn>0?`<small>VAT ${j(Xn)} (${v(String(ei||0))}%) on top</small>`:""}
                            </span>
                            <span class="fin-transaction-row-primary">
                                <strong class="fin-val-pos">${j(Pn)}</strong>
                        ...
                        <div class="fin-chip-row">
                            ${kt(ze)}
                            ${kt(xi(P,ze))}
                            <span class="fin-status-pill">${Math.round(Sn*100)}% reliable</span>
                        </div>
        ...
        `:'<input id="fin-ledger-source" aria-label="Filter records by source" value="all" type="hidden" />',wn=$.length?`
            <select id="fin-ledger-import-batch" aria-label="Filter records by import batch">
                ...
                ${$.map(P=>{const ze=Bt({importBatchId:P}),ft=ze&&ze.sourceFile?`${ze.sourceFile} · ${P}`:P;return`<option value="${v(P)}"${String(a.importBatchId)===P?" selected":""}>${v(ft)}</option>`}).join("")}
            </select>
        `:'<input id="fin-ledger-import-batch" aria-label="Filter records by import batch" value="all" type="hidden" />',na=sn(a),En=[{id:"all",label:"All records",active:![a.accountId&&a.accountId!=="all",a.scope&&a.scope!=="all",String(a.categoryId||"").trim(),a.type&&a.type!=="all",a.reviewStatus&&a.reviewStatus!=="all",a.source&&a.source!=="all",a.importBatchId&&a.importBatchId!=="all",a.linkState&&a.linkState!=="all",String(a.amountMin||"").trim(),String(a.amountMax||"").trim(),a.dateFrom,a.dateTo].some(Boolean)},{id:"review",label:"Needs review",active:a.reviewStatus==="needs_review"},{id:"linked",label:"Linked",active:a.linkState==="linked"},{id:"unlinked",label:"Unlinked",active:a.linkState==="unlinked"},{id:"expenses",label:"Expenses",active:a.type==="expense"}],$t=`
            <div class="fin-ledger-toolbar" aria-label="Record filters">
                <div class="fin-ledger-filter-bar">
                    ...
                    <div class="fin-ledger-filter-presets" aria-label="Common record filters">
                        ${En.map(P=>`<button class="fin-ledger-preset-chip ${P.active?"active":""}" type="button" data-fin-action="set-ledger-filter-preset" data-fin-ledger-preset="${v(P.id)}">${v(P.label)}</button>`).join("")}
                    </div>
                ...
                <div class="fin-ledger-filter-advanced" aria-label="Advanced record filters">
                    <select id="fin-ledger-account" aria-label="Filter records by account">${Rt(a.accountId)}</select>
                    ...
                    <select id="fin-ledger-scope" aria-label="Filter records by scope">${ur(a.scope)}</select>
        ...
        `:"";let Ue="";return D==="work"?Ue=`
                ...
                ${z.length?z.map(yn).join(""):Me("No transactions need review for the current filters.")}
            `:D==="matched"?Ue=k.length?k.map(gi).join(""):Me("Matched payments will appear here after records are linked to obligations, income, debt, or reserves."):D==="expected"?Ue=Ei.length?Ei.map(ta).join(""):Me("Expected income will appear here. Add upcoming invoices, retainers, confirmed income, proposals, or overdue payments."):Ue=w.length?w.map(gi).join(""):Me("Begin tracking. Add your first payment or sync a CSV."),`
        ...
        `}function Yt(i,a){return`
            ${zt({title:i.title,meta:`${i.reason} · ${i.kind||"review"}`,rightHtml:kt(i.tone==="urgent"?"overdue":"needs_review"),actionHtml:a,iconHtml:Fe("review",{size:"sm",tone:i.tone==="urgent"?"danger":"muted"}),extraClass:"fin-review-row"})}
        `}function ui(i){return i.length?`
        ...
        `:Me("Saved CSV mappings will appear here after a successful import.")}function cn(i){return i.length?`
            ...
            <section class="fin-section">
                <div class="fin-operational-row">
                    ...
                    <div class="widget ui-card glass fin-card fin-board-frame">
                        ...
                        ${zt({title:i.ok?"Healthy":"Needs attention",meta:`${Number(i.eventCount||0)} finance events${i.latestEventAt?` · latest ${ke(i.latestEventAt)}`:""}`,amount:`${i.issues.length} issue${i.issues.length===1?"":"s"}`,iconHtml:Fe(i.ok?"success":"warning",{size:"sm",tone:i.ok?"success":"danger"}),extraClass:"fin-board-list-row"})}
                        <div class="backup-preview-card">
        ...
        `}function mi(i,a="monthly"){const s=Math.abs(Number(i)||0),l=String(a||"monthly").toLowerCase().replace(/[\s-]+/g,"_");return l==="weekly"||l==="week"?s*52/12:l==="biweekly"||l==="two_weekly"||l==="every_two_weeks"||l==="fortnightly"?s*26/12:l==="quarterly"||l==="quarter"?s/3:l==="yearly"||l==="annual"||l==="annually"?s/12:s}function it(i){const a=Number(i&&i.monthlyPressure);if(Number.isFinite(a))return Math.max(0,a);const s=Number(i&&i.minimumPaymentMonthly);return Number.isFinite(s)?Math.max(0,s):mi(i&&i.minimumPayment,i&&i.frequency)}function bn(i){const a=String(i&&i.planStatus||"").trim();return a&&a!=="missing"?!0:!!(i&&i.planType==="custom"&&G(i.installments).length>0||it(i)>0||String(i&&i.paymentPlanNote||"").trim())}function Di(i){const a=String(i&&i.planStatus||(bn(i)?"active":"missing")).replace(/_/g," ");return a.charAt(0).toUpperCase()+a.slice(1)}function Yi(i){return G(i).reduce((a,s)=>{const l=Math.max(0,Number(s&&s.targetAmount)||0),g=Math.max(0,Number(s&&s.currentAmount)||0);return a+Math.max(0,l-g)},0)}function p(i){const a={};try{const s=localStorage.getItem("finance-master.ui.expenseOrder");s&&JSON.parse(s).forEach((l,g)=>{a[l]=g})}catch{}return G(i).slice().sort((s,l)=>{const g=Object.prototype.hasOwnProperty.call(a,s&&s.id)?a[s.id]:99999,S=Object.prototype.hasOwnProperty.call(a,l&&l.id)?a[l.id]:99999;return g-S})}function ee(i,a){const s=Math.max(1,Math.abs(Number(a)||0));return Math.max(6,Math.min(100,Math.abs(Number(i)||0)/s*100))}function be(i,a){return G(i).length?G(i).map(s=>`
            ${zt({title:s.category||"Recurring cost",meta:`Due day ${String(s.dueDay||"not set")} · ${s.scope||"shared"} · ${a}`,amount:`${j(s.monthlyAmount)} / mo`,actionHtml:me({action:"FinancialMode.openAddModal",args:`'expense', '${$e(s.id)}'`,label:`Edit ${s.category||"recurring cost"}`}),iconHtml:Fe("calendar",{size:"sm",tone:"muted"}),extraClass:"fin-treasury-compact-row"})}
        ...
        `}function Qt(i){const a=Math.max(0,Number(i.outstanding)||0),s=Math.max(0,Number(i.totalAdded)||0),l=Math.max(0,Number(i.totalPaid)||0),g=s>0?Math.min(100,Math.round(l/s*100)):0,S=it(i),$=bn(i);return`
            ...
            `}function Kn(i){const a=G(i).filter(l=>Math.max(0,Number(l&&l.outstanding)||0)>0).sort((l,g)=>it(g)-it(l)||String(l&&l.name||"").localeCompare(String(g&&g.name||"")));return a.length?`
            <div class="fin-debt-control-panel">
                ${[["active_pressure","Active pressure","Counting in current monthly pressure"],["starts_later","Starts later","Visible as future pressure, not current burn"],["on_hold","On hold","Tracked as liability, paused from current pressure"],["irregular","Irregular","Only custom monthly pressure counts"],["no_plan","No plan","Liability exists but pressure needs a decision"],["completed_archived","Completed / archived","Kept out of active calculations"]].map(([l,g,S])=>{const $=a.filter(w=>Ct(w)===l);return $.length?`
                        <div class="fin-debt-control-group" data-debt-group="${v(l)}">
                            ...
                            <div class="fin-treasury-debt-grid">${$.map(Qt).join("")}</div>
                        </div>
                    `:""}).join("")}
            </div>
        `:Me("Debt-free operations.")}function Yn(){return G(e?.projectProfiles).filter(i=>i&&String(i.status||"active")!=="archived").sort((i,a)=>String(i.name||"").localeCompare(String(a.name||"")))}function qr(i){return String(i&&i.projectId||"").trim()}function Vr(i,a){const s=String(a||"all");if(s==="all")return!0;const l=qr(i);return s==="unassigned"?!l:l===s}function Ci(i,a){return G(i).reduce((s,l)=>s+(Number(a(l))||0),0)}function Hr(){const i=Yn(),a=de(),s=i.find(we=>String(we.id)===a)||null,l=a==="unassigned"||s?a:"all";l!==a&&xe(l);const g=l!=="all",S=l==="all"?"All Money Plan":l==="unassigned"?"Unassigned":String(s?.name||"Project plan"),$=we=>G(we).filter(Lt=>Vr(Lt,l)),w=$(e?.fiatAccounts),D=$(e?.reserveBuckets),z=$(e?.recurringExpenses),k=$(e?.debtAccounts),M=$(e?.pipelineDeals),E=$(e?.invoices),ce=$(e?.transactions),se=new Set(w.map(we=>String(we.id||"")).filter(Boolean));return{selected:l,label:S,project:s,projects:i,isProjectView:g,fiatAccounts:w,reserveBuckets:D,recurringExpenses:z,debtAccounts:k,pipelineDeals:M,invoices:E,transactions:ce,accountIds:se}}function Wr(i){const a=G(i?.projects),s=String(i?.selected||"all"),l=(g,S,$="")=>`
        ...
        `}function Gr(){const i=Hr(),a=G(i.fiatAccounts),s=G(i.reserveBuckets),l=G(i.debtAccounts),g=p(i.recurringExpenses),S=g.filter(ne=>ne&&ne.essential),$=g.filter(ne=>!ne||!ne.essential),w=S.reduce((ne,Ue)=>ne+(Number(Ue.monthlyAmount)||0),0),D=$.reduce((ne,Ue)=>ne+(Number(Ue.monthlyAmount)||0),0),z=l.reduce((ne,Ue)=>ne+it(Ue),0),k=Ci(a,ne=>ne.balance),M=Ci(s,ne=>ne.currentAmount),E=w+D+z,ce=k-M-E,se=i.isProjectView?k:ge("actualCash",ge("totalCash",Number(t?.realBalance)||0)),we=i.isProjectView?M:ge("protectedCash",ge("reservedCash",Number(t?.reservedCash)||0)),Lt=i.isProjectView?E:ge("committedShortTermObligations",0),Je=i.isProjectView?ce:ge("availableCash",Number.isFinite(Number(t?.availableCash))?Number(t.availableCash):se-we),pt=i.isProjectView?E:ge("totalMonthlyBurn",Number(t?.monthlyBurn)||w+D+z),dn=i.isProjectView?pt>0?Je/pt:null:Number(o?.runwayMonths??t?.runwayMonths),Fi=Number.isFinite(dn)?`${dn.toFixed(1)} months`:"Unknown",xt=l.filter(ne=>Math.max(0,Number(ne&&ne.outstanding)||0)>0),ea=Ci(a.filter(ne=>{const Ue=String(ne&&ne.bucket||"available");return!!(ne&&ne.reserved)||Ue!=="available"}),ne=>ne.balance),Ti=Ci(s,ne=>ne.currentAmount),gi=i.isProjectView?xt.reduce((ne,Ue)=>ne+(Number(Ue.outstanding)||0),0):ge("debtRemaining",Ba("debtBurden",xt.reduce((ne,Ue)=>ne+(Number(Ue.outstanding)||0),0))),yn=xt.filter(ne=>String(ne&&ne.planStatus||"")==="missing"||!bn(ne)),Ei=Math.max(0,xt.length-yn.length),ta=s.reduce((ne,Ue)=>ne+Math.max(0,Number(Ue.targetAmount)||0),0),vi=Yi(s),wn=Je-w-D-z,na=Math.max(1,Math.abs(Je),w,D,z,we,Math.abs(wn));let Tn=typeof window.Store.getGoalProgress=="function"?window.Store.getGoalProgress(window.Store.getUiSettings().scopeFilter||"all"):[];i.isProjectView&&(Tn=G(Tn).filter(ne=>G(ne.linkedAccountIds).some(Ue=>i.accountIds.has(String(Ue)))));let En={className:"is-stable"};Je<0||wn<0?En={label:"Critical shortfall",className:"is-critical",copy:"Near-term obligations need coverage before future goals."}:Number.isFinite(dn)&&dn<2?En={label:"Tight runway",className:"is-watch",copy:"Cash covers a thin operating window."}:yn.length?En={label:"Needs plan",className:"is-watch",copy:"Debt plans need confirmation for reliable burn."}:vi>0&&(En={label:"Needs protection",className:"is-watch",copy:"Reserve targets are not fully protected yet."});let $t={primaryLabel:"Open Reality Check",primaryAction:"FinancialMode.setSection",primaryArgs:"'review'",secondary:[]};Je<0||wn<0?$t={title:"Cover near-term obligations before funding savings goals",body:"Free cash is under pressure. Stabilize the next 30 days before adding to future goals.",primaryLabel:"Allocate available cash",primaryAction:"openEditModal",primaryArgs:"'allocateReserves'",secondary:[{label:"Review flexible costs",localAction:"open-treasury-panel",section:"treasury-burn-flexible"},...xt.length?[{label:"Open debt planner",action:"FinancialMode.openAddModal",args:`'debtPlan', '${$e((yn[0]||xt[0]||{}).id||"")}'`}]:[]]}:yn.length?$t={title:"Confirm debt payment plans",body:"Monthly pressure is clearer once every liability has a payment plan.",primaryLabel:"Open debt planner",primaryAction:"FinancialMode.openAddModal",primaryArgs:`'debtPlan', '${$e(yn[0].id)}'`,secondary:[{label:"Review debt pressure",localAction:"open-treasury-panel",section:"treasury-debt-details"}]}:vi>0?$t={title:"Protect priority reserves",body:"Some money still needs a job. Fund the most important bucket first.",primaryLabel:"Add reserve bucket",primaryAction:"openEditModal",primaryArgs:"'reserveBucket'",secondary:[{label:"Allocate cash",action:"openEditModal",args:"'allocateReserves'"}]}:D>w*.35&&D>0&&($t={title:"Review flexible costs",body:"A small cut to discretionary burn can extend your breathing room.",primaryLabel:"Review flexible costs",primaryLocalAction:"open-treasury-panel",primarySection:"treasury-burn-flexible",secondary:[{label:"Add recurring cost",action:"FinancialMode.openAddModal",args:"'expense'"}]}),$t.primaryLocalAction?pe({label:$t.primaryLabel,action:$t.primaryLocalAction,local:!0,variant:"primary",attrs:`data-fin-section="${v($t.primarySection)}"`}):pe({label:$t.primaryLabel,action:$t.primaryAction,args:$t.primaryArgs||"",variant:"primary"}),G($t.secondary).map(ne=>ne.localAction?pe({label:ne.label,action:ne.localAction,local:!0,attrs:`data-fin-section="${v(ne.section||"")}"`}):pe({label:ne.label,action:ne.action,args:ne.args||""})).join("");const ia=[{label:"Cash available",value:Je,tone:"safe"},{label:"Essential costs",value:-w,tone:"essential"},{label:"Flexible costs",value:-D,tone:"flexible"},{label:"Debt pressure",value:-z,tone:"debt"},{label:"Protected reserves",value:we,tone:"protected"},{label:wn>=0?"Resulting surplus":"Resulting shortfall",value:wn,tone:wn>=0?"safe":"critical"}];return`
            ${Wr(i)}

            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-treasury-pulse ${En.className}">
                    ...
                    <div class="fin-treasury-pulse-side">
                        ...
                        <div class="fin-treasury-pulse-grid">
                            ...
                            <div><span>Debt plans confirmed</span><strong>${Ei} of ${xt.length}</strong></div>
                            <div><span>Protected</span><strong>${j(we)}</strong>${Fn("protectedCash")}</div>
                            <div><span>Monthly burn</span><strong>${j(pt)}</strong>${Fn("monthlyBurnRate")}</div>
                        </div>
                    </div>
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-treasury-flow-card">
                    ...
                    <div class="fin-treasury-pulse-grid">
                        <div><span>Actual cash</span><strong>${j(se)}</strong>${Fn("actualCash")}</div>
                        <div><span>Protected cash</span><strong>${j(we)}</strong>${Fn("protectedCash")}</div>
                        <div><span>Due in 30 days</span><strong>${j(Lt)}</strong></div>
                        <div><span>Payment-plan burn</span><strong>${j(z)}</strong>${Fn("debtPressure")}</div>
                        <div><span>Total liability</span><strong>${j(gi)}</strong></div>
                        <div><span>Structural runway</span><strong>${v(Fi)}</strong>${Fn("runway")}</div>
                    </div>
                    <div class="fin-treasury-flow">
                        ${ia.map(ne=>`
                            <div class="fin-treasury-flow-step is-${v(ne.tone)}">
                                ...
                                <div class="fin-treasury-flow-track"><span style="width:${ee(ne.value,na)}%"></span></div>
                            </div>
                        `).join("")}
                    </div>
                </div>
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-treasury-vault">
                    ...
                    <div class="fin-treasury-vault-summary">
                        ...
                        <div><span>Protected account allocations</span><strong>${j(ea)}</strong></div>
                        <div><span>Reserve bucket balances</span><strong>${j(Ti)}</strong></div>
                        <div><span>Reserve target</span><strong>${j(ta)}</strong></div>
                        <div><span>Still to protect</span><strong>${j(vi)}</strong></div>
                    </div>
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-treasury-burn">
                    ...
                    <div class="fin-treasury-burn-grid">
                        ...
                        <div><span>Essential</span><strong>${j(w)}</strong><small>${Xt(S.length,"item")}</small></div>
                        <div><span>Flexible</span><strong>${j(D)}</strong><small>${Xt($.length,"item")}</small></div>
                        <div><span>Debt payment plans</span><strong>${j(z)}</strong><small>${Xt(xt.length,"liability","liabilities")}</small></div>
                    </div>
                    ${Nt("treasury-burn-essential","Essential Costs",`${j(w)} / month · ${Xt(S.length,"item")}`,be(S,"Essential"))}
                    ${Nt("treasury-burn-flexible","Flexible Costs",`${j(D)} / month · ${Xt($.length,"item")}`,be($,"Flexible"))}
                </div>
            </section>
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-treasury-debt">
                    ...
                    <div class="fin-treasury-pressure-line">
                        <div><span>Total debt</span><strong>${j(gi)}</strong></div>
                        <div><span>Payment-plan burn</span><strong>${j(z)}</strong></div>
                        <div><span>Liabilities</span><strong>${xt.length}</strong></div>
                        <div><span>Plans missing</span><strong>${yn.length}</strong></div>
                    </div>
                    ${Kn(xt)}
                </div>
            </section>
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-treasury-goals">
                    <div class="fin-goals-heading">
                        ...
                        ${pe({label:Tn.length?"Manage goals":"Add goal",action:"openEditModal",args:`'${Tn.length?"goals":"goal"}'`})}
                    </div>
                    ${Tn.length?`
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-treasury-accounts">
                    ${Nt("treasury-accounts","Account Details",`${j(se)} across ${Xt(a.length,"cash account")}`,`
                        <div class="fin-section-heading-row">
                            <div>
        ...
        `;return`
            <section class="fin-section">
                ...
                <div class="fin-snapshot-grid fin-snapshot-grid--cockpit">
                    <div class="widget ui-card glass fin-tile">
                        ...
                        <div class="fin-tile-subline">${Xt(i.length,"recurring cost")}</div>
                    </div>
                    <div class="widget ui-card glass fin-tile">
                        <div class="fin-tile-label">Essential</div>
                        <div class="fin-tile-value">${j(w)}</div>
                        <div class="fin-tile-subline">${Xt(S.length,"item")} · cannot cut</div>
                    </div>
                    <div class="widget ui-card glass fin-tile">
                        <div class="fin-tile-label">Flexible</div>
                        <div class="fin-tile-value">${j(D)}</div>
                        <div class="fin-tile-subline">${Xt($.length,"item")} · can reduce</div>
                    </div>
                    <div class="widget ui-card glass fin-tile">
                        <div class="fin-tile-label">Total debt</div>
                        <div class="fin-tile-value fin-text-med">${j(z)}</div>
                        <div class="fin-tile-subline">${Xt(a.length,"liability","liabilities")}</div>
                    </div>
                </div>
            </section>
            ...
            <section class="fin-section">
                ...
                ${a.length?a.map(E=>{const ce=bn(E),se=it(E),we=E.totalAdded>0?Math.min(100,Math.round((E.totalPaid||0)/E.totalAdded*100)):0;return`
                    <div class="fin-board-panel fin-debt-card">
                        ${zt({title:E.name,meta:`${E.scope||"shared"}${E.dueDate?` · Due ${ke(E.dueDate)}`:""}`,amount:j(E.outstanding),amountClass:"fin-text-med",iconHtml:Fe("debt",{size:"sm",tone:ce?"muted":"danger"}),actionHtml:`
                                <div class="fin-inline-icon-actions">
                        ...
                        <div class="fin-debt-details">
                            ${E.planType==="custom"?`<span>Custom Plan: ${E.installments?.length||0} installments</span>`:se>0?`<span>${Di(E)} pressure: ${j(se)} / month</span>`:""}
        ...
        `}function Yr(){const i=window.Store.getFinanceSettings(),a=window.Store.getUiSettings(),s=a.scopeFilter==="business"?"Business only":a.scopeFilter==="personal"?"Personal only":"All scopes",l=a.reducedMotion?"On":"Off";return`
            <section class="fin-section">
                <!-- App Preferences -->
        ...
        `}function ln(i){return G(o&&o[i])}function ge(i,a=0){const s=Number(o&&o[i]);return Number.isFinite(s)?s:a}function Ba(i,a=0){const s=Number(c&&c[i]&&c[i].value);return Number.isFinite(s)?s:a}function Qr(i){return i==="subtract"?"Subtract":i==="divide"?"Divide by":i==="multiply"?"Multiply by":"Add"}function Zr(i,a){const s=String(i&&i.key||""),l=Number(a)||0;return s==="runway"?`${l.toFixed(1)} months`:s==="forecastConfidence"?`${Math.round(l)}%`:j(l)}function Fn(i){const a=c&&c[i];if(!a||!Array.isArray(a.parts))return"";const s=String(a.label||i);return`<span class="fin-metric-info" data-fin-explainer="${v(i)}">${un(i,s)}</span>`}function Jr(i){const s=(Array.isArray(i)?i:[i]).map(l=>c&&c[l]).filter(l=>l&&Array.isArray(l.parts));return s.length?`
                    ...
                    <div class="fin-info-formula-group" aria-label="${v(l.label||"Metric")} formula">
                        ...
                        ${l.parts.map(g=>`
                            <div class="fin-info-formula-row">
                                <span>${Qr(g.operation)} ${v(g.label)}</span>
                                <strong>${Zr(l,g.value)}</strong>
                            </div>
                        `).join("")}
                        ${G(l.warnings).map(g=>`
        ...
        `:""}function Xr(){const i=G(e&&e.fiatAccounts).slice(0,6);return`
            <section class="fin-info-popover-section">
                    ...
                    ${S.length?`
                        <table class="fin-table fin-table--compact">
                            ...
                            <tbody>
                                ${S.map(M=>`
                                    <tr>
                                        <td>${v(M.title)}<small>${v([M.incomeType==="retainer"?"retainer":M.incomeType==="recurring"?"recurring":"",ki(M),M.projectLabel,M.settlementAccount].filter(Boolean).join(" · "))}</small>${Number(M.vatAmount)>0?`<small>VAT ${j(M.vatAmount)} (${v(String(M.vatRate||0))}%) on top</small>`:""}</td>
                                        <td>${kt(M.status)}</td>
                                        <td>${kt(M.dueState)}</td>
                                        <td>${M.expectedDateISO?ke(M.expectedDateISO):"No date"}</td>
                                        <td>${Math.round(M.probability*100)}%<small>${v(La(M))}</small></td>
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame ${a?"fin-income-lane-card":""}">
                    ...
                    <div class="fin-status-grid">
                        <div class="fin-status-card">${kt("confirmed")}<strong>${j($.reliable)}</strong><span>Confirmed, invoiced, due, or overdue</span></div>
                        <div class="fin-status-card">${kt("expected")}<strong>${j($.expected)}</strong><span>Expected, retainer, or recurring income</span></div>
                        <div class="fin-status-card">${kt("proposal")}<strong>${j($.early)}</strong><span>Proposal, lead, or legacy low-confidence income</span></div>
                        <div class="fin-status-card">${kt("overdue")}<strong>${j($.overdue)}</strong><span>Needs follow-up</span></div>
                    </div>
            ...
            <div class="fin-decision-card ${s}" data-decision-card="${v(i&&i.id||`decision-${a}`)}">
                <div class="fin-decision-card-head">
                    <div class="fin-decision-signal">
                        <span class="fin-decision-signal-icon">${Fe(ho(i),{size:"sm",tone:s==="is-opportunity"?"success":s==="is-warning"?"warning":s==="is-critical"?"danger":"muted"})}</span>
                        <span>${v(bo(i))}</span>
                    </div>
                ...
                <div class="fin-decision-card-actions">
                    ${fi(i&&i.actionLabel,i&&i.actionRoute,l?"fin-mini-btn--primary":"")}
                </div>
            </div>
        `}function wo(i,a){return`
            <div class="fin-decision-focus-item" data-decision-focus="${v(i&&i.id||`focus-${a}`)}">
                ...
                ${fi(i&&i.actionLabel,i&&i.actionRoute)}
            </div>
        `}function Zi(i,a){const s=G(h&&h[i]).slice(0,5);return`
            <div class="fin-decision-timeline-column" data-decision-timeline="${v(i)}">
                ...
                ${s.length?s.map(l=>`
                    ${zt({title:l.label||"Pressure",meta:`${l.kind||"Item"} · ${ke(l.date)}`,amount:j(Math.abs(Number(l.amount)||0)),amountClass:Number(l.amount)>=0&&String(l.kind||"").toLowerCase().includes("income")?"fin-val-pos":"",iconHtml:Fe(Number(l.amount)>=0?"money-in":"calendar",{size:"sm",tone:Number(l.amount)>=0?"success":"muted"}),extraClass:"fin-decision-timeline-item fin-board-list-row",attrs:`data-timeline-source="${v(l.sourceId||l.id||"")}"`})}
                `).join(""):Me("No dated pressure in this window.")}
            </div>
        `}function So(i,a=0){return zt({title:i&&i.title||"Revenue opportunity",meta:`${i&&i.sourceData||"Cash Timeline opportunity"} · ${i&&i.metricImpact||"Runway impact"}${i&&i.optionalScenario?" · scenario-ready":""}`,iconHtml:Fe("money-in",{size:"sm",tone:"success"}),actionHtml:fi(i&&i.actionLabel||"Open Cash Timeline",i&&i.actionRoute||"flow"),extraClass:"fin-board-list-row fin-decision-opportunity-row",attrs:`data-decision-opportunity="${v(i&&i.id||`opportunity-${a}`)}"`})}function $o(i){return`
        ...
        `}function Io(){const i=y&&y.topScenario,a=Math.max(100,Math.round(Number(i&&i.amount)||Number(t&&t.monthlyBurn)||500));return`
            <section class="fin-section">
        ...
        `}function Ao(){const i=f||mr({readModel:e||{},snapshot:t||{},treasury:o||{},forecast:u||{},roadmapMetrics:m||{},reviewState:r||{},settings:window.Store.getUiSettings()||{},nowIso:new Date().toISOString()}),a=i.status||{},s=G(i.weeklyFocus).slice(0,3),l=G(i.decisionCards).slice(0,6),g=G(i.opportunities).slice(0,4),S=G(i.scenarioShortcuts),$=ge("safeToSpend",Number(t&&t.safeToSpend)||0),w=o?.runwayMonths!=null?o.runwayMonths:t?.runwayMonths,D=ln("reviewQueue").length;return`
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-decisions-hero ${za(a.severity)}">
            ...
            <section class="fin-section">
                <div class="fin-decisions-grid">
                    <div class="widget ui-card glass fin-card fin-board-frame fin-decisions-focus">
                        ...
                        ${s.length?s.map((z,k)=>wo(z,k)).join(""):Me("No urgent focus. Keep the weekly review cadence.")}
                    </div>
                </div>
            </section>
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-decisions-cards">
                    <div class="fin-section-heading-row">
                        ...
                        ${fi("Open Risk Radar","radar")}
                    </div>
                    <div class="fin-decision-card-grid">
                        ${l.length?l.map((z,k)=>yo(z,k)).join(""):Me("No decision cards for the current local data.")}
                    </div>
                </div>
            </section>
                ...
                <div class="fin-decisions-grid">
                    ...
                    <div class="widget ui-card glass fin-card fin-board-frame fin-decisions-opportunities">
                        ...
                        <div class="fin-decision-opportunity-list">
                            ${g.length?g.map((z,k)=>So(z,k)).join(""):Me("Add dated opportunities in Cash Timeline to see runway impact.")}
                        </div>
                    </div>
                </div>
            </section>
        `}function Ji(i){return String(i||"scenario").replace(/_/g," ")}function Mo(i,a={}){if(i==null)return"—";const s=Number(i)||0,l=s>0?"+":"";return a.months?`${l}${s.toFixed(1)} mo`:`${l}${j(s)}`}function Zn(i,a,s,l,g={}){return`
            <div class="fin-scenario-metric">
                <span>${v(i)}</span>
                <strong>${g.months?s==null?"—":`${Number(s).toFixed(1)} mo`:j(s)}</strong>
                <small class="${Number(l)>0?"fin-val-pos":Number(l)<0?"fin-val-neg":""}">Base ${g.months?a==null?"—":`${Number(a).toFixed(1)} mo`:j(a)} · ${Mo(l,g)}</small>
            </div>
        `}function qa(){const i=y||pr({readModel:e||{},snapshot:t||{},treasury:o||{},forecast:u||{},decisionEngine:f||{},savedScenarios:window.Store.getSavedScenarios().scenarios||[],nowIso:new Date().toISOString()}),a=G(i.comparable),s=a.find(g=>String(g.id)===String(N))||a[0]||null,l=new Set(G(i.saved).map(g=>String(g.id)));return`
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-scenario-lab-v2" data-scenario-lab="v2">
                        ...
                        <div class="fin-board-panel fin-scenario-picker">
                            ...
                            ${a.slice(0,8).map(g=>`
                                <button class="fin-scenario-choice ${String(s&&s.id)===String(g.id)?"active":""}" type="button" data-fin-action="set-scenario-preview" data-fin-scenario-id="${v(g.id)}" data-scenario-choice="${v(g.type)}">
                                    <span><strong>${v(g.name)}</strong><small>${v(Ji(g.type))} · impact ${v(String(Math.round(g.impactScore)))}</small></span>
                        ...
                        <div class="fin-board-panel fin-scenario-preview" data-scenario-preview="${v(s&&s.id||"")}">
                            ...
                            ${s?`
                                <div class="fin-scenario-metric-grid">
                                    ${Zn("Safe-to-Spend",s.base.safeToSpend,s.adjusted.safeToSpend,s.delta.safeToSpend)}
                                    ${Zn("Available cash",s.base.availableCash,s.adjusted.availableCash,s.delta.availableCash)}
                                    ${Zn("Monthly burn",s.base.monthlyBurn,s.adjusted.monthlyBurn,s.delta.monthlyBurn)}
                                    ${Zn("Runway",s.base.runway,s.adjusted.runway,s.delta.runway,{months:!0})}
                                    ${Zn("Debt pressure",s.base.debtPressure,s.adjusted.debtPressure,s.delta.debtPressure)}
                                    ${Zn("Reserve gap",s.base.reserveGap,s.adjusted.reserveGap,s.delta.reserveGap)}
                                </div>
                    ...
                    <div class="fin-board-panel fin-scenario-saved" aria-label="Saved scenarios">
                        ...
                        ${G(i.saved).length?G(i.saved).map(g=>`
                            ${zt({title:g.name,meta:`${Ji(g.type)} · ${j(g.amount)}`,actionHtml:`
        ...
        `}function No(){const i=oo(),a=so(),s=co(a),l=lo(),g=uo({dependency:i,expenseGravity:a,debt:s,reserve:l}),S=mo(g,i,a,s,l),$=po(),w=fo({expenseGravity:a,debt:s,reserve:l}),D=go({risks:g,dependency:i,debt:s,reserve:l,scenario:w}),z=Math.max(1,a.essentialTotal,a.flexibleTotal,s.monthlyPressure,a.taxReserveGap);return`
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-insights-hero">
                    ...
                    <div class="fin-insights-hero-summary">
                        <div>${Fe("warning",{size:"sm",tone:Qn((g[0]||{}).level)>=2?"danger":"muted"})}<span>Main risk</span><strong>${v(S.mainRisk)}</strong></div>
                    ...
                    <div class="widget ui-card glass fin-card fin-board-frame fin-insights-memory">
                        ...
                        ${$.history.length>=($.required||3)?`
                            ...
                            <div class="fin-insights-memory-list">
                                ${$.rows.map(k=>vo(k.label,k.value,k.copy,{plain:k.plain})).join("")}
                            </div>
                        `:`
                            ...
                            <div class="fin-insights-source-list">
                                ${i.rows.map(k=>`
                                    <div class="fin-insights-source-row">
                                        <div><strong>${v(k.source)}</strong><span>${v(Xt(k.count,"item"))}${k.kinds?` · ${v(k.kinds)}`:""}</span></div>
        ...
        `}function Do(){const i=ln("reviewQueue").length,a=Jn();return`
            <section class="fin-section fin-section--toolbar">
                <div class="fin-ui-toolbar">
                    ...
                    <div class="fin-toolbar-actions">
                        <select id="fin-scope-filter" class="fin-scope-filter" aria-label="Treasury scope">${ur(window.Store.getUiSettings().scopeFilter||"all")}</select>
                    </div>
                </div>
            </section>
        `}function Xi(){const i=Number(u&&u.byHorizon&&u.byHorizon[30]&&u.byHorizon[30].expected);if(Number.isFinite(i))return i;const a=o?.incomeScenarios||{},s=Number(a.expected);if(Number.isFinite(s))return s;const l=Number(t?.projectedBalance);return Number.isFinite(l)?l:ge("availableCash",0)}function Co(){return o?.runwayMonths!=null?o.runwayMonths:t?.runwayMonths}function xo(i){const a=String(i&&i.type||""),s=$e(i&&i.id||"");return String(i&&i.id)==="month-end-gap"?{label:"Adjust reserves",action:"FinancialMode.setSection",args:"'plan'"}:String(i&&i.id)==="monthly-review"?{label:"Save checkpoint",action:"FinancialMode.setSection",args:"'review'"}:a==="Overdue"?{label:"Review income",action:"FinancialMode.setSection",args:"'flow'"}:a==="Due soon"?{label:"Review obligation",action:"FinancialMode.setSection",args:"'review'"}:a==="Missing forecast input"?{label:"Add income",action:"FinancialMode.openAddModal",args:"'income'"}:a==="Missing plan"&&/reserve/i.test(String(i&&i.title||""))?{label:"Add reserve",action:"FinancialMode.openAddModal",args:"'reserveBucket'"}:a==="Missing plan"?{label:"Confirm plan",action:"openEditModal",args:`'debtPlan', '${s}'`}:a==="Needs review"?{label:"Categorize",action:"FinancialMode.setSection",args:"'review'"}:{label:"Review",action:"FinancialMode.setSection",args:"'review'"}}function ko(i){const a=String(i&&i.type||"");return String(i&&i.id||"")==="month-end-gap"||a==="Overdue"?"Critical":a==="Due soon"||a==="Missing plan"?"Needs review":"Housekeeping"}function Fo(i){const a=String(i&&i.type||""),s=String(i&&i.id||"");return s==="month-end-gap"?"Current plan closes short in the next 30 days.":s==="monthly-review"?"Close the monthly loop when you have a minute.":a==="Overdue"?"Expected income or payment is past its date.":a==="Due soon"?"A confirmed obligation needs a decision.":a==="Missing plan"?"Add a plan so burn and runway stay accurate.":a==="Missing forecast input"?"Add expected income to sharpen the forecast.":a==="Needs review"?"Classify this item so totals stay clean.":"Small cleanup that improves the cockpit."}function To(){const i=Xi(),a=Jn(),s=G(t?.attentionQueue),l=ln("reviewQueue").filter($=>!s.some(w=>String(w&&w.id||"")===String($&&$.id||""))).map($=>({type:$&&$.tone==="urgent"?"Overdue":$&&$.kind==="transaction"?"Needs review":"Missing plan",title:$&&$.title,amount:$&&$.amount,action:$&&$.actionLabel,id:$&&($.targetId||$.id),original:$})),g=[...i<0?[{type:"Critical",title:"Projected month-end gap",amount:-Math.abs(i),action:"Adjust reserves",id:"month-end-gap"}]:[],...a?[{type:"Needs review",title:"Checkpoint",amount:null,action:"Save checkpoint",id:"monthly-review"}]:[],...s,...l].map($=>{const w=ko($),D=xo($);return{id:String($&&$.id||$&&$.title||w),group:w,title:String($&&$.title||"Review item"),amount:$&&$.amount,reason:Fo($),button:D}}),S={Critical:0,"Needs review":1,Housekeeping:2};return g.sort(($,w)=>(S[$.group]??9)-(S[w.group]??9)).slice(0,5)}function Eo(i){const a=Number(i);return Number.isFinite(a)?a<3?{label:"Thin",className:"is-critical"}:a<6?{label:"Watch",className:"is-watch"}:{label:"Stable",className:"is-steady"}:{label:"Unknown",className:"is-watch"}}function Po(i,a,s){const l=String(i||"").toLowerCase();return Number(a)<0||l==="stormy"?"risky":l==="tight"?"tight":l==="watchful"||Number(a)<Math.max(250,Number(s)||0)?"watchful":"safe"}function Ro(i){return i==="risky"?"is-critical":i==="tight"||i==="watchful"?"is-watch":"is-steady"}function Oo(){return yt().filter(a=>{const s=pi(a);return s!=="lead"&&s!=="proposal"&&s!=="risky"}).sort((a,s)=>(Date.parse(String(a&&a.expectedDateISO||""))||Number.MAX_SAFE_INTEGER)-(Date.parse(String(s&&s.expectedDateISO||""))||Number.MAX_SAFE_INTEGER))[0]||null}function _o(i=5){return ln("obligations").filter(a=>String(a&&a.status||"")!=="paid").sort((a,s)=>(Date.parse(String(a&&a.dueDate||""))||Number.MAX_SAFE_INTEGER)-(Date.parse(String(s&&s.dueDate||""))||Number.MAX_SAFE_INTEGER)).slice(0,i)}function jo(i){const a=wi({title:"Next Money In",subtitle:"The closest incoming money with enough reliability to track.",actions:un("nextMoneyIn","Next Money In")});if(!i)return`
                <div class="fin-pulse-mini-card fin-widget">
                    ${a}
                    <div class="fin-widget-body">
                    ${Me("Add confirmed or expected income in Cash Timeline.")}
                    </div>
                    ${ni(pe({label:"Add income",action:"FinancialMode.openAddModal",args:"'income'",variant:"primary"}))}
                </div>
            `;const s=pi(i),l=Number.isFinite(Number(i.probability))?Math.round(Number(i.probability)*100):0;return`
            <div class="fin-pulse-mini-card fin-widget">
                ${a}
                <div class="fin-widget-body fin-widget-body--list">
                    ${zt({title:i.title||"Expected income",meta:[ke(i.expectedDateISO),ki(i),s,`${l}% reliable`].filter(Boolean).join(" · "),amount:j(Number(i.value)||0),amountClass:"fin-val-pos",iconHtml:Fe("money-in",{size:"sm",tone:"success"})})}
        ...
        `}function Uo(){const i=window.Store&&typeof window.Store.getSampleDataStatus=="function"?window.Store.getSampleDataStatus():null;return!i||!i.isSampleData?"":`
                        ...
                        <div class="fin-weather-signals">
                            ${a.map(l=>`
                                <div class="fin-weather-signal">
                                    <div class="fin-weather-signal-icon">${Fe(Ho(l),{size:"sm",tone:String(l.severity||"").toLowerCase()==="critical"?"danger":"muted"})}</div>
                                    <div>
        ...
        `}function Go(){const i=Oo(),a=_o(5);return`
            <section class="fin-section">
        ...
        `}function Ko(){const i=ge("totalMonthlyBurn",Number(t?.monthlyBurn)||0),a=Xi(),s=m?.reserveHealth||{},l=m?.dangerZone||{},g=[{label:"30-day net",value:`${a>=0?"+":""}${j(a)}`,route:"flow",tone:a<0?"fin-val-neg":"fin-text-safe"},{label:"Monthly burn",value:j(i),route:"plan"},{label:"Reserves funded",value:`${Number(s.coveragePercent||0)}%`,route:"plan"},{label:"Forecast low",value:l.lowestAmount==null?"—":j(l.lowestAmount),route:"flow",tone:Number(l.lowestAmount)<0?"fin-val-neg":""}];return`
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-tiny-trend-strip">
                    <div class="fin-section-heading-row">
                        ...
                        ${un("trendStrip","Tiny Trend Strip")}
                    </div>
        ...
        `}function Yo(){const i=ln("reviewQueue");return`
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-review-list-card">
                    ...
                    ${i.length?i.map(s=>Yt(s,Qo(s))).join(""):Me("All items reviewed and reconciled.")}
                </div>
            </section>
        `}function Qo(i){const a=String(i&&i.kind||"setup"),s=$e(i&&(i.targetId||i.id)||"");return a==="transaction"?Ve({action:"openEditModal",args:`'transactionReview', '${s}'`,label:"Edit transaction review"}):a==="payment"?Ve({action:"openEditModal",args:`'paymentMatch', '${s}'`,label:"Edit payment match"}):a==="pipeline"?Ve({action:"openEditModal",args:`'pipelineReview', '${s}'`,label:"Edit income review"}):a==="debt"?Ve({action:"openEditModal",args:`'debtPlan', '${s}'`,label:"Edit payment plan"}):a==="obligation"?Ve({action:"openEditModal",args:`'obligationPayment', '${s}'`,label:"Edit obligation review"}):String(i&&i.id)==="missing-cash"?Ve({action:"FinancialMode.openAddModal",args:"'fiatAccount'",label:"Edit cash accounts"}):String(i&&i.id)==="missing-burn"?Ve({action:"FinancialMode.openAddModal",args:"'expense'",label:"Edit recurring costs"}):Ve({action:"FinancialMode.setSection",args:"'review'",label:v(i&&i.actionLabel||"Review item")})}function Zo(){const i=ln("obligations").filter(g=>["overdue","due_soon","needs_review"].includes(String(g&&g.status||""))).slice(0,12),a=i.filter(g=>String(g&&g.status||"")==="overdue"),s=i.filter(g=>String(g&&g.status||"")==="due_soon"),l=i[0]||null;return`
            <section class="fin-section">
        ...
        `}function Jo(){const i=G(e&&e.transactions).filter(g=>String(g&&g.type)==="expense.recorded").slice(0,8),a=i.filter(g=>!g.obligationId),s=i.filter(g=>g.obligationId),l=a[0]||i[0]||null;return`
            <section class="fin-section">
        ...
        `}function Xo(){const i=u||Vi({readModel:e||{},snapshot:t||{},treasury:o||{},nowIso:new Date().toISOString()}),a=[7,30,60,90,180].map(g=>i.byHorizon&&i.byHorizon[String(g)]).filter(Boolean),s=G(i.warnings).slice(0,4),l=ge("availableCash",Number(t?.availableCash)||0);return`
            <section class="fin-section">
            ...
            <section class="fin-section">
                <div class="widget ui-card glass fin-card fin-board-frame fin-calendar-card fin-flow-timeline-card">
                    ...
                    <div class="fin-calendar-lows">
                        ${i.lows.map(se=>{const we=is(se,w);return`<div class="${we.className}" data-flow-low="${se.horizon}">
                    ...
                    <div class="fin-calendar-events">
                        ${E.length?E.map(se=>`
                            ${zt({title:se.label,meta:`${se.kind} · ${ke(se.date)}`,amount:`${se.amount>=0?"+":"-"}${j(Math.abs(se.amount))}`,amountClass:se.amount>=0?"fin-val-pos":"fin-val-neg",iconHtml:Fe(ts(se),{size:"sm",tone:se.amount>=0?"success":String(se.kind||"").toLowerCase().includes("debt")?"danger":"muted"}),extraClass:`fin-calendar-event fin-board-list-row is-${ns(se)}`,attrs:`data-flow-timeline-item="${v(se.sourceId||se.id||"")}"`})}
                        `).join(""):Me("Add dated income, recurring costs, or payment plans to shape the Cash Timeline.")}
                    </div>
                </div>
            </section>
        `}function rs(){const i=window.Store.getUiSettings().scopeFilter||"all",a=typeof window.Store.getGoalProgress=="function"?window.Store.getGoalProgress(i):[];return`
            <section class="fin-section">
        ...
        `}function os(){const i=yt(),a=G(e&&e.invoices).filter(w=>String(w&&w.status||"").toLowerCase()==="paid").sort((w,D)=>new Date(D.paidAt||D.sentAt||0)-new Date(w.paidAt||w.sentAt||0)),s=i.reduce((w,D)=>w+(Number(D.value)||0)*(Number(D.probability)||0),0),l=i.map(w=>({title:w.title||"Pipeline item",weighted:(Number(w.value)||0)*(Number(w.probability)||0)})).sort((w,D)=>D.weighted-w.weighted).slice(0,4),g=_t(),S=Q();let $="";return S==="history"?$=a.length?`
                    <table class="fin-table fin-table--compact">
                ...
                ${i.length?`
                    <table class="fin-table fin-table--compact">
                        ...
                        <tbody>
                            ${i.map(w=>{const D=pi(w),z=xi(w,D),k=Number(w.probability||0),M=Qi(w.projectId);return`
                                <tr>
                                    <td>${v(w.title||"Pipeline item")}<small>${v([w.incomeType==="retainer"?"retainer":w.incomeType==="recurring"?"recurring":"",ki(w),M].filter(Boolean).join(" · "))}</small></td>
                                    <td>${kt(D)}</td>
                                    <td>${kt(z)}</td>
                ...
                `:""}
                ${ni(pe({label:"Add pipeline item",action:"FinancialMode.openAddModal",args:"'income'",variant:"primary"}))}
            `,`
	            <section class="fin-section">
	                <div class="widget ui-card glass fin-card fin-board-frame">
        ...
        `}function ds(){const i=document.getElementById("fin-projection-svg");if(!i||!window.FinancialEngine||typeof window.FinancialEngine.generateProjections!="function")return;const a=window.FinancialEngine.generateProjections({financeSnapshot:t,financeReadModel:e},{burnChange:0,probFloor:.5,marketShift:0}),s=a.safe||[],l=a.realistic||[],g=a.optimistic||[],S=s.concat(l).concat(g),$=Math.max(1,...S),w=Math.min(0,...S),D=960,z=280,k=24,M=12,E=16,ce=28,se=(D-k-M)/Math.max(1,s.length-1),we=function(Je){const pt=$-w||1;return E+($-Je)/pt*(z-E-ce)},Lt=function(Je){return Je.map((pt,dn)=>`${dn===0?"M":"L"} ${k+dn*se} ${we(pt)}`).join(" ")};i.innerHTML=`
            ...
            <path d="${Lt(s)}" fill="none" stroke="var(--fin-chart-safe)" stroke-width="2.35"></path>
            <path d="${Lt(l)}" fill="none" stroke="var(--fin-chart-realistic)" stroke-width="2.35"></path>
            <path d="${Lt(g)}" fill="none" stroke="var(--fin-chart-optimistic)" stroke-width="1.9"></path>
        `}function us(i,a){console.log("[FinancialMode] Opening modal for:",i),window.openEditModal&&(a?window.openEditModal(i,{id:String(a)}):window.openEditModal(i))}function ms(){if(!window.Store)return;const i=document.getElementById("page-settings-currency"),a=document.getElementById("page-settings-forecast"),s=document.getElementById("page-settings-scope"),l=document.getElementById("page-settings-appearance"),g=document.getElementById("page-settings-reduced-motion");if(i&&a&&s&&l&&g)try{window.Store.saveFinanceSettings({baseCurrency:i.value||"EUR",forecastDays:Number(a.value)||90}),window.Store.saveUiSettings({appearance:l.value||"dark-editorial",reducedMotion:g.checked,scopeFilter:s.value||"all"}),window.applyAppearance&&window.applyAppearance(window.Store),window.FinancialMode.render()}catch(S){console.error("Failed to save settings:",S),window.showModalError&&window.showModalError(S.message||"Could not save settings.")}}function ps(i,a){const s=G(e?.recurringExpenses),l=s.find(E=>String(E.id)===String(i));if(!l)return;const g=l.essential,S=s.filter(E=>E.essential===g),$={};try{const E=localStorage.getItem("finance-master.ui.expenseOrder");E&&JSON.parse(E).forEach((se,we)=>$[se]=we)}catch{}S.sort((E,ce)=>{const se=$.hasOwnProperty(E.id)?$[E.id]:99999,we=$.hasOwnProperty(ce.id)?$[ce.id]:99999;return se-we});const w=S.findIndex(E=>String(E.id)===String(i));if(w===-1)return;const D=w+Number(a);if(D<0||D>=S.length)return;const z=S[w];S[w]=S[D],S[D]=z;const k=s.filter(E=>E.essential!==g);k.sort((E,ce)=>{const se=$.hasOwnProperty(E.id)?$[E.id]:99999,we=$.hasOwnProperty(ce.id)?$[ce.id]:99999;return se-we});const M=[...g?S:k,...g?k:S].map(E=>String(E.id));try{localStorage.setItem("finance-master.ui.expenseOrder",JSON.stringify(M))}catch{}ve()}return{init:jt,render:ve,setSection:U,toggleMobileNav:pn,closeMobileNav:He,setFocusMode:F,setPipelineTab:X,openAddModal:us,saveSettingsPage:ms,moveExpense:ps}})();window.Store=te;window.FinanceFormatting={formatCurrencyAmount:vs,resolveCurrencyCode:fr};await te.initialize();te.seedDemoIfNeeded();_a(te);window.FinancialMode?.init();window.addEventListener("finance:ui-updated",()=>{_a(te),window.FinancialMode?.render()});
